...
- [OK] streamable_http: mcp-server.json _meta.transports=3 values, a2a agent_card advertises stdio+streamable_http, src/doc markers=1/29
...
- [OK] 5_canary: canary/rolling anchors=10
- [OK] 6_degradation: degradation anchors=19
- [OK] 7_failover: failover/DR anchors=57
