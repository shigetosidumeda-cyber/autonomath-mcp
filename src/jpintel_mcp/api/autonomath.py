...
def _apply_envelope(
    ...
    *,
    ...
    additive = (
        ...
        # not transit MCP). 業法 fence (行政書士法 §1の2 / 貸金業法 §3 /
...
def rest_search_acceptance_stats(
    ...
    return JSONResponse(
        content=_apply_envelope(
            ...
            # ("search_acceptance_stats_am" — 行政書士法 §1の2 fence).
...
@router.get(
    ...
    description=(
        ...
        "公表) with structured detail rows for grant_refund / "
        "subsidy_exclude / fine breakdown.\n\n"
