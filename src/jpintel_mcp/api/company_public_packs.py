...
§52 / 司法書士法 §3 / 行政書士法 §1の2 territory): the ``_disclaimer`` envelope
from the company public-information substrate lists those statutes, and
...
_SENSITIVE_BUSINESS_LAW_DISCLAIMER = (
    ...
    "司法書士法 §3、行政書士法 §1の2 の業務独占範囲に該当する助言・代理・書面作成は"
...
@router.post(
    ...
    description=(
        "法人番号・インボイス・行政処分・採択履歴などの公開情報素材を取得し、"
