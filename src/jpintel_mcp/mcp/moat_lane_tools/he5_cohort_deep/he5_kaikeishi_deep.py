"""HE-5 cohort-specific deep — 会計士 (kaikeishi). D-tier ¥30."""
...
def agent_cohort_deep_kaikeishi(
    query: Annotated[
        str,
        Field(min_length=1, max_length=512, description="会計士 free-text query."),
    ],
    entity_id: Annotated[
        str | None,
        Field(
    ...
    """[AUDIT, SENSITIVE — §52/§47条の2/§72/§1/§3] Moat HE-5 cohort deep — 会計士.
    ...
    Cohort: 会計士 (kaikeishi). NO LLM inference.
    """
...
__all__ = ["agent_cohort_deep_kaikeishi"]
