"""HE-5 cohort-specific deep — 司法書士 (shihoshoshi). D-tier ¥30."""
...
def agent_cohort_deep_shihoshoshi(
    query: Annotated[
        str,
        Field(min_length=1, max_length=512, description="司法書士 free-text query."),
    ],
    entity_id: Annotated[
        str | None,
        Field(
    ...
    """[AUDIT, SENSITIVE — §52/§47条の2/§72/§1/§3] Moat HE-5 cohort deep — 司法書士.
    ...
    Cohort: 司法書士 (shihoshoshi). NO LLM inference. ``司法書士法 §3``
...
__all__ = ["agent_cohort_deep_shihoshoshi"]
