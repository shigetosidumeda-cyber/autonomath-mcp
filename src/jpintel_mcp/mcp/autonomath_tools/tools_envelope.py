...
search_tax_incentives = with_envelope(
    "search_tax_incentives", query_arg="query"
)(_raw.search_tax_incentives)

search_certifications = with_envelope(
    "search_certifications", query_arg="query"
)(_raw.search_certifications)

list_open_programs = with_envelope(
    "list_open_programs", query_arg="query"
)(_raw.list_open_programs)

search_by_law = with_envelope(
    "search_by_law", query_arg="law_name"
)(_raw.search_by_law)

active_programs_at = with_envelope(
    "active_programs_at", query_arg="query"
)(_raw.active_programs_at)

related_programs = with_envelope(
    "related_programs", query_arg="program_id"
)(_raw.related_programs)

search_acceptance_stats = with_envelope(
    "search_acceptance_stats", query_arg="program_name"
)(_raw.search_acceptance_stats)

enum_values = with_envelope(
    "enum_values", query_arg="enum_name"
)(_raw.enum_values)

intent_of = with_envelope(
    "intent_of", query_arg="query"
)(_raw.intent_of)

reason_answer = with_envelope(
    "reason_answer", query_arg="query"
)(_raw.reason_answer)
