...
from . import (
    ...
    personalization_mcp,  # noqa: F401  — Wave 46 dim 19 SFGH booster (2026-05-12): personalization_recommendations_am — MCP wrapper over api/personalization_v2.py (Dim H, Wave 43.2.8). Top-N (顧問先 × 制度) materialized scores. AUTONOMATH_PERSONALIZATION_MCP_ENABLED gate (default ON). NO LLM (scores precomputed by refresh_personalization_daily.py cron), single ¥3/req billing event. §52/§47条の2/§72/§1 envelope. REST companion at GET /v1/me/recommendations.
