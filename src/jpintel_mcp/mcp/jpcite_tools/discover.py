"""jpcite_tools.discover — Wave 46.47.C re-export alias for autonomath_tools.discover.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.discover import …`
...
registration that happens inside `autonomath_tools.discover` runs once
...
from jpintel_mcp.mcp.autonomath_tools.discover import *  # noqa: F401, F403
