"""jpcite_tools.tools_envelope — Wave 46.47.C re-export alias for autonomath_tools.tools_envelope.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.tools_envelope import …`
...
registration that happens inside `autonomath_tools.tools_envelope` runs once
...
from jpintel_mcp.mcp.autonomath_tools.tools_envelope import *  # noqa: F401, F403
