"""jpcite_tools.legal_chain_v2 — Wave 46.47.C re-export alias for autonomath_tools.legal_chain_v2.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.legal_chain_v2 import …`
...
registration that happens inside `autonomath_tools.legal_chain_v2` runs once
...
from jpintel_mcp.mcp.autonomath_tools.legal_chain_v2 import *  # noqa: F401, F403
