"""jpcite_tools.industry_packs — Wave 46.47.C re-export alias for autonomath_tools.industry_packs.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.industry_packs import …`
...
registration that happens inside `autonomath_tools.industry_packs` runs once
...
from jpintel_mcp.mcp.autonomath_tools.industry_packs import *  # noqa: F401, F403
