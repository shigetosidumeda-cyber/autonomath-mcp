"""jpcite_tools.db — Wave 46.47.C re-export alias for autonomath_tools.db.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.db import …`
...
registration that happens inside `autonomath_tools.db` runs once
...
from jpintel_mcp.mcp.autonomath_tools.db import *  # noqa: F401, F403
