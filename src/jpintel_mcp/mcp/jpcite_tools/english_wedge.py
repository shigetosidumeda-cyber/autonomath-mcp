"""jpcite_tools.english_wedge — Wave 46.47.C re-export alias for autonomath_tools.english_wedge.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.english_wedge import …`
...
registration that happens inside `autonomath_tools.english_wedge` runs once
...
from jpintel_mcp.mcp.autonomath_tools.english_wedge import *  # noqa: F401, F403
