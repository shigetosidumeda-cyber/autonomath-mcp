"""jpcite_tools.recommend_similar — Wave 46.47.C re-export alias for autonomath_tools.recommend_similar.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.recommend_similar import …`
...
registration that happens inside `autonomath_tools.recommend_similar` runs once
...
from jpintel_mcp.mcp.autonomath_tools.recommend_similar import *  # noqa: F401, F403
