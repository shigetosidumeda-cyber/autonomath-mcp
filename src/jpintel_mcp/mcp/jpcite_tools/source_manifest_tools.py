"""jpcite_tools.source_manifest_tools — Wave 46.47.C re-export alias for autonomath_tools.source_manifest_tools.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.source_manifest_tools import …`
...
registration that happens inside `autonomath_tools.source_manifest_tools` runs once
...
from jpintel_mcp.mcp.autonomath_tools.source_manifest_tools import *  # noqa: F401, F403
