"""jpcite_tools.autonomath_wrappers — Wave 46.47.C re-export alias for autonomath_tools.autonomath_wrappers.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.autonomath_wrappers import …`
...
registration that happens inside `autonomath_tools.autonomath_wrappers` runs once
...
from jpintel_mcp.mcp.autonomath_tools.autonomath_wrappers import *  # noqa: F401, F403
