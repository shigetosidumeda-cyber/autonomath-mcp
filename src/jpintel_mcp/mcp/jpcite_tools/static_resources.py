"""jpcite_tools.static_resources — Wave 46.47.C re-export alias for autonomath_tools.static_resources.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.static_resources import …`
...
registration that happens inside `autonomath_tools.static_resources` runs once
...
from jpintel_mcp.mcp.autonomath_tools.static_resources import *  # noqa: F401, F403
