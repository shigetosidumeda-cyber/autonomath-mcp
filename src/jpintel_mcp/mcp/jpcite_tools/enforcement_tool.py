"""jpcite_tools.enforcement_tool — Wave 46.47.C re-export alias for autonomath_tools.enforcement_tool.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.enforcement_tool import …`
...
registration that happens inside `autonomath_tools.enforcement_tool` runs once
...
from jpintel_mcp.mcp.autonomath_tools.enforcement_tool import *  # noqa: F401, F403
