"""jpcite_tools.shihoshoshi_tools — Wave 46.47.C re-export alias for autonomath_tools.shihoshoshi_tools.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.shihoshoshi_tools import …`
...
registration that happens inside `autonomath_tools.shihoshoshi_tools` runs once
...
from jpintel_mcp.mcp.autonomath_tools.shihoshoshi_tools import *  # noqa: F401, F403
