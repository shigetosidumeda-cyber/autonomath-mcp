"""jpcite_tools.wave24_tools_second_half — Wave 46.47.C re-export alias for autonomath_tools.wave24_tools_second_half.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.wave24_tools_second_half import …`
...
registration that happens inside `autonomath_tools.wave24_tools_second_half` runs once
...
from jpintel_mcp.mcp.autonomath_tools.wave24_tools_second_half import *  # noqa: F401, F403
