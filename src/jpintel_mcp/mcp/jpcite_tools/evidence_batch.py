"""jpcite_tools.evidence_batch — Wave 46.47.C re-export alias for autonomath_tools.evidence_batch.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.evidence_batch import …`
...
registration that happens inside `autonomath_tools.evidence_batch` runs once
...
from jpintel_mcp.mcp.autonomath_tools.evidence_batch import *  # noqa: F401, F403
