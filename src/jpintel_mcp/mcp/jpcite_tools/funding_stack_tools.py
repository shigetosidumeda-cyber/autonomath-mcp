"""jpcite_tools.funding_stack_tools — Wave 46.47.C re-export alias for autonomath_tools.funding_stack_tools.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.funding_stack_tools import …`
...
registration that happens inside `autonomath_tools.funding_stack_tools` runs once
...
from jpintel_mcp.mcp.autonomath_tools.funding_stack_tools import *  # noqa: F401, F403
