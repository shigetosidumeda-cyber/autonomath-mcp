"""jpcite_tools.envelope_wrapper — Wave 46.47.C re-export alias for autonomath_tools.envelope_wrapper.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.envelope_wrapper import …`
...
registration that happens inside `autonomath_tools.envelope_wrapper` runs once
...
from jpintel_mcp.mcp.autonomath_tools.envelope_wrapper import *  # noqa: F401, F403
