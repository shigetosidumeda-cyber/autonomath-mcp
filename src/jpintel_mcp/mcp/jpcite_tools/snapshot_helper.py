"""jpcite_tools.snapshot_helper — Wave 46.47.C re-export alias for autonomath_tools.snapshot_helper.

See `jpcite_tools.__init__` for the full rationale. This wrapper exists
so callers can write `from jpintel_mcp.mcp.jpcite_tools.snapshot_helper import …`
...
registration that happens inside `autonomath_tools.snapshot_helper` runs once
...
from jpintel_mcp.mcp.autonomath_tools.snapshot_helper import *  # noqa: F401, F403
