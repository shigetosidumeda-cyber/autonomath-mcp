...
特商法表記: https://autonomath.ai/tokushoho.html
利用規約: https://autonomath.ai/tos.html
プライバシーポリシー: https://autonomath.ai/privacy.html
"""
...
<p style="font-size:12px;color:#555;line-height:1.7;margin:0">
  ...
  <a href="https://autonomath.ai/tokushoho.html" style="color:#1e3a8a">特商法表記</a> ・
  <a href="https://autonomath.ai/tos.html" style="color:#1e3a8a">利用規約</a> ・
  <a href="https://autonomath.ai/privacy.html" style="color:#1e3a8a">プライバシーポリシー</a>
</p>
"""
...
def _unsubscribe_url(token: str) -> str:
    ...
    """
    return f"https://autonomath.ai/alerts-unsubscribe.html?token={token}"
    ...
    *,
    ...
    if mode == "digest":
        ...
        closing = (
            ...
            "https://autonomath.ai/alerts.html からアップグレードできます。"
        )
    else:
        ...
        closing = (
            ...
            "配信頻度・対象の変更は https://autonomath.ai/alerts.html から可能です。"
        )
