...
「中小企業基本法 第 5 条」。法令データは e-Gov 法令 API (CC-BY 4.0) で 法令本文索引 6,493 件 + 法令メタデータ 9,484 件 (本文ロード継続中)、`unified_id` 経由で個別本文を引く。本文未取得の法令は法令名 / 法令番号 / e-Gov リンクの resolver として参照可能。
