...
179 tools at default gates (165 dim K-S baseline + 4 Wave 51 chains + 10 Wave 59-B outcome wrappers), MCP protocol `2025-06-18`, FastMCP over stdio. 完全なリストと引数は [docs/mcp-tools.md](./docs/mcp-tools.md) を参照 (Single source of truth)。
...
The standard distribution exposes 179 tools for Japanese public-program
