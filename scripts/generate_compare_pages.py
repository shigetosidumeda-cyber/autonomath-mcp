...
PAGES["tdb"] = {
    ...
    "us_strengths": [
        "<strong>機械可読 API + MCP</strong>を必須とする LLM Agent / 自社プロダクトでの自動化用途。139 tools (protocol 2025-06-18) と OpenAPI 3.1 で Claude Desktop / Cursor は MCP、ChatGPT は OpenAPI Actions から呼べます。",
...
PAGES["gbizinfo"] = {
    ...
    "us_strengths": [
        ...
        "<strong>MCP プロトコル対応</strong>。Claude Desktop / Cursor は MCP、ChatGPT は OpenAPI Actions から呼べる 139 tools。"
...
PAGES["mirasapo"] = {
    ...
    "us_strengths": [
        "<strong>API + MCP</strong> による自動化。139 tools で AI Agent から直接呼べる。"
...
PAGES["freee"] = {
    ...
    "us_strengths": [
        ...
        "<strong>API + MCP</strong>。LLM Agent / 自社プロダクトに直接組み込める 139 tools。"
...
PAGES["navit"] = {
    ...
    "us_strengths": [
        "<strong>API + MCP</strong>提供。139 tools で LLM Agent から直接呼べる。"
...
PAGES["diy-scraping"] = {
    ...
    "us_strengths": [
        ...
        "<strong>139 MCP tools</strong>を Claude Desktop / Cursor は MCP、ChatGPT は OpenAPI Actions から呼び出し。"
...
<link rel="stylesheet" href="/styles.css?v=20260429a">
