...
```
93 at default gates (4 additional tools gated off pending fix: query_at_snapshot, intent_of, reason_answer, related_programs; 2 further tools held behind AUTONOMATH_36_KYOTEI_ENABLED for 社労士法 review)
```
...
```
- Honest tool count is 93 at default gates. Earlier listings of "66" or "72" reflect older snapshots (manifest bumps on 2026-04-25 and v0.3.2 audit on 2026-04-29).
