...
```
155 MCP tools over Japanese institutional data — subsidies, laws, court decisions, tax rulesets, invoice registrants — with primary-source URLs on major public rows.
```
...
```
- Honest tool count is 155 at default gates. Earlier listings of "66" or "72" reflect older snapshots (manifest bumps on 2026-04-25 and v0.3.2 audit on 2026-04-29).
