...
```
139 MCP tools over Japanese institutional data: 11,684 subsidies + laws + court + tax + invoice registrants. ¥3/req (¥3.30 tax-incl). 3/day free anon.
```
...
- 139 tools at default gates (3 additional gated off pending fix: query_at_snapshot, intent_of, reason_answer)
...
```
[Server submission] AutonoMath — 139-tool MCP for Japanese institutional data
```
