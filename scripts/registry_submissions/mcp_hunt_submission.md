...
```
151-tool MCP for Japanese institutional data — subsidies, laws, court decisions, tax rulesets, invoice registrants.
```
...
- 151 tools at default gates (4 broken tools gated off pending fix)
