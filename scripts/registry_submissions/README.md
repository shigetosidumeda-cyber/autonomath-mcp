...
| Tool count | **139 at default gates** (3 additional gated off pending fix; 2 further behind `AUTONOMATH_36_KYOTEI_ENABLED`) |
...
4. **README.md authoritative numbers**: matches the canonical facts above (139 tools, 6,493 laws full-text indexed, 9,484 law metadata records, 4,300 sourced compat pairs, ¥3/billable unit tax-exclusive (¥3.30 tax-inclusive) metered).
