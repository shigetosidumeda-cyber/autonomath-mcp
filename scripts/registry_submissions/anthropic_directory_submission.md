...
```
Search Japanese institutional data: 11,601 subsidies + 6,493 laws full-text indexed + 2,065 court decisions + 13,801 invoice registrants. 139 MCP tools. ¥3/req (¥3.30 tax-incl). 3/day free anon.
```
