...
- [ ] README.md renders the pinned tool count (139 at default gates)
...
```bash
git add <index-file>
git commit -m "Add AutonoMath: 139-tool MCP for Japanese institutional data"
...
```
Add AutonoMath: 139-tool MCP for Japanese institutional data (subsidies / laws / tax / court / invoice)
```
...
- **139 tools at default gates** (`tools/list` runtime count, AUTONOMATH_ENABLED=1)
