...
- [ ] README.md renders the pinned tool count (151 at default gates)
...
```bash
git add <index-file>
git commit -m "Add AutonoMath: 151-tool MCP for Japanese institutional data"
...
```
Add AutonoMath: 151-tool MCP for Japanese institutional data (subsidies / laws / tax / court / invoice)
```
...
- **151 tools at default gates** (`tools/list` runtime count, AUTONOMATH_ENABLED=1)
