...
- [ ] README.md renders the pinned tool count (184 at default gates)
...
- **184 tools at default gates** (`tools/list` runtime count, AUTONOMATH_ENABLED=1)
