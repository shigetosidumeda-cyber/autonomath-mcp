...
add(
    ...
    URL,
    "MCP support",
    "MCP サーバー (autonomath-mcp PyPI 互換) + 手動設定 / DXT bundle。155 tools。",
    "公開情報なし。",
    "",
)
add(
...
add(
    ...
    URL,
    "Subsidy / 制度 DB",
    "11,601 件 検索可。主要な公開行に primary source URL + fetched_at。",
    "<strong>対象外</strong>。同社は信用調査専業で公的制度 DB は提供せず。",
    "",
)
add(SLUG, NAME_JA, NAME_EN, URL, "Tax ruleset DB", "50 件 (am_tax_rule)。", "対象外。", "")
add(
    SLUG,
    NAME_JA,
    NAME_EN,
...
add(SLUG, NAME_JA, NAME_EN, URL, "MCP support", "MCP サーバー、155 tools。", "公開情報なし。", "")
add(
    SLUG,
    NAME_JA,
    NAME_EN,
...
add(SLUG, NAME_JA, NAME_EN, URL, "Subsidy / 制度 DB", "11,601 件。", "対象外 (信用調査専業)。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Tax ruleset DB", "50 件。", "対象外。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Court decisions / 判例", "2,065 件。", "対象外。", "")
add(
    SLUG,
    NAME_JA,
    NAME_EN,
...
add(SLUG, NAME_JA, NAME_EN, URL, "Free tier", "匿名 3 req/日/IP。", "完全無料。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Sample contract length", "なし — 利用規約のみ。", "なし。", "")
add(
    SLUG,
    NAME_JA,
    NAME_EN,
...
add(
    ...
    URL,
    "API access",
    "REST + MCP。11,601 制度を横断検索。",
    "検索 UI のみ。<strong>API 公開なし</strong> (2026-04 時点公開情報)。",
    "",
)
add(SLUG, NAME_JA, NAME_EN, URL, "MCP support", "155 tools。", "公開情報なし。", "")
add(
    SLUG,
    NAME_JA,
    NAME_EN,
...
add(SLUG, NAME_JA, NAME_EN, URL, "JP corporate count", "166,969 件。", "対象外。", "")
add(
    SLUG,
    NAME_JA,
    NAME_EN,
...
add(
    ...
    NAME_EN,
    URL,
    "Expert matching / 専門家紹介",
    "<strong>なし</strong> (検索 + 適合判定が主機能)。",
    "<strong>あり</strong> (中小企業診断士・士業マッチング)。",
    "人的支援は同社、機械可読は当社。",
)
add(
    SLUG, NAME_JA, NAME_EN, URL, "Terms of use", "ToS 同意で開始。", "政府標準利用規約 2.0 系。", ""
)
add(SLUG, NAME_JA, NAME_EN, URL, "Free tier", "匿名 3 req/日/IP。", "完全無料。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Sample contract length", "なし — 利用規約のみ。", "なし。", "")
add(
...
add(SLUG, NAME_JA, NAME_EN, URL, "JP corporate count", "166,969 件。", "対象外 (顧客自身)。", "")
add(
    SLUG,
    NAME_JA,
    NAME_EN,
...
add(SLUG, NAME_JA, NAME_EN, URL, "Terms of use", "ToS 同意で開始。", "freee 利用規約に従属。", "")
add(
    SLUG,
    NAME_JA,
    NAME_EN,
...
add(
    ...
    URL,
    "Subsidy / 制度 DB",
    "11,601 件 (47 都道府県 + 省庁 + 自治体 1,500+ ソース)。",
