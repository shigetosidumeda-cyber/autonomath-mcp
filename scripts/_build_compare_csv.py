...
add(SLUG, NAME_JA, NAME_EN, URL, "API access",
    "REST + MCP (OpenAPI 3.1, MCP protocol 2025-06-18) で全機能を提供。/v1/* 公開、認証なしでも 50 req/月/IP。",
    "API は法人向け契約で別途提供 (公開価格なし) — 2026-04 月時点で公開ページに API/MCP 仕様の記載なし。",
    "")
add(SLUG, NAME_JA, NAME_EN, URL, "MCP support",
    "公式 MCP サーバー (autonomath-mcp PyPI) + Smithery / DXT 配布。89 tools。",
    "公開情報なし。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Pricing model",
    "完全従量 ¥3/req 税別 (税込 ¥3.30)、最低料金/契約期間/Seat 課金なし。匿名 50 req/月/IP 無料。",
...
add(SLUG, NAME_JA, NAME_EN, URL, "Subsidy / 制度 DB",
    "10,790 件 (tier S=114 / A=1,340 / B=3,292 / C=6,044)。99%+ に primary source URL + fetched_at。",
    "<strong>対象外</strong>。同社は信用調査専業で公的制度 DB は提供せず。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Tax ruleset DB",
    "35 件 (am_tax_rule)。", "対象外。", "")
...
add(SLUG, NAME_JA, NAME_EN, URL, "API access",
    "REST + MCP (OpenAPI 3.1)。匿名 50 req/月/IP 無料。",
    "tsr-van2 等の法人向け情報サービスを提供 — Web/専用回線。API/MCP の公開仕様は公開情報なし。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "MCP support",
    "公式 MCP サーバー、89 tools。", "公開情報なし。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Pricing model",
    "¥3/req 完全従量 (税込 ¥3.30)。",
...
add(SLUG, NAME_JA, NAME_EN, URL, "Court decisions / 判例",
    "2,065 件。", "対象外。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Invoice registrants / 適格請求書",
    "13,801 件 delta + 月次フル取込予定。", "対象外。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Primary source citations",
    "99%+ の行に source_url + fetched_at。", "独自取材ベース。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Terms of use",
...
add(SLUG, NAME_JA, NAME_EN, URL, "MCP support",
    "89 tools (protocol 2025-06-18)。", "公開情報なし。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Pricing model",
    "¥3/req 完全従量 (税込 ¥3.30)。",
...
add(SLUG, NAME_JA, NAME_EN, URL, "Court decisions / 判例",
    "2,065 件。", "対象外。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Invoice registrants / 適格請求書",
    "13,801 件 delta + 月次フル取込予定。",
    "対象外 (国税庁公表サイトと連携可能だが gBizINFO 内部 DB は別)。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Primary source citations",
    "99%+ に source_url + fetched_at。",
    "出典は政府機関 (一次)。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Terms of use",
...
add(SLUG, NAME_JA, NAME_EN, URL, "JP corporate count",
    ...
    "適格請求書発行事業者の網羅性では同サイトが圧倒。当社は月次 bulk 取込で同期予定。")
add(SLUG, NAME_JA, NAME_EN, URL, "Subsidy / 制度 DB",
    "10,790 件。", "対象外 (国税庁は税務専業)。", "")
add(SLUG, NAME_JA, NAME_EN, URL, "Tax ruleset DB",
    "35 件。",
