...
def _spec_pages() -> list[QAPage]:
    ...
    pages.append(
        QAPage(
            ...
            h1="jpcite MCPで何ができる?",
            tldr="Claude Desktop / Cursor / Cline から139 toolsを呼び、日本の制度・法令・判例・税制を検索できる。",
            qa_pairs=[
                (
                ...
                (
                    "ツール数はいくつですか?",
                    "公開ファクトシート上の正本では、標準構成で 139 MCP tools です。制度検索、制度詳細、batch detail、排他ルール、採択事例、法令、税制、判例、provenance lookup などに分かれます。",
                ),
                (
                    "匿名で試せますか?",
