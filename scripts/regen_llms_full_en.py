...
def _section_audiences() -> list[str]:
    return [
        ...
        "5. AI agent developers - 155 MCP tools, ¥3 per billable unit, 3 anonymous requests per day. Primary tools: full surface area; see https://jpcite.com/docs/mcp-tools/.",
        "",
        "---",
        "",
    ]
