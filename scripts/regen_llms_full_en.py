...
def _section_about() -> list[str]:
    return [
        ...
        "",
        "MCP exposes 72 tools at default gates (39 jpintel + 33 autonomath: 17 V1 + 4 V4 universal + 5 Phase A absorption + 7 graph/lifecycle/snapshot tools). The MCP server runs over stdio (protocol 2025-06-18) and is compatible with Claude Desktop, Cursor, and ChatGPT (Plus and above).",
        "",
...
def _section_audiences() -> list[str]:
    return [
        ...
        "5. AI agent developers - 72 MCP tools, ¥3 per request, 50 free per month. Primary tools: full surface area; see https://autonomath.ai/docs/mcp-tools/.",
        "",
        "---",
        "",
    ]
