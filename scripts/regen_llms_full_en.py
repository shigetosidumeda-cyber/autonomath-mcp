...
def _section_about() -> list[str]:
    return [
        ...
        "",
        "MCP exposes 184 tools in the standard configuration. The MCP server runs over stdio (protocol 2025-06-18) for Claude Desktop, Cursor, Cline, and other MCP clients. ChatGPT Custom GPTs use the OpenAPI Actions integration instead.",
        "",
...
def _section_audiences() -> list[str]:
    return [
        ...
        "5. AI agent developers - 184 MCP tools, ¥3 per billable unit, 3 anonymous requests per day. Primary tools: full surface area; see https://jpcite.com/docs/mcp-tools/.",
        "",
        "---",
        "",
    ]
