...
def _detail_url(table: str, unified_id: str) -> str:
    ...
    """
    if table == "programs":
        return f"https://autonomath.ai/programs/{unified_id}"
    if table == "laws":
        return f"https://autonomath.ai/docs/laws/{unified_id}"
    if table == "court_decisions":
        return f"https://autonomath.ai/docs/court_decisions/{unified_id}"
    if table == "tax_rulesets":
        return f"https://autonomath.ai/docs/tax_rulesets/{unified_id}"
    if table == "enforcement_cases":
        return f"https://autonomath.ai/docs/enforcement/{unified_id}"
    return ""
