...
SEED_ROWS: list[EnfRow] = [
    ...
    # ===== 秋田県 =====
    EnfRow("有限会社秋田東通永井組", "2025-12-08", "秋田県", "license_revoke",
           "産業廃棄物処理業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.akita.lg.jp/pages/archive/6663"),
    EnfRow("株式会社後藤建設", "2023-12-28", "秋田県", "license_revoke",
           "産業廃棄物処理業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.akita.lg.jp/pages/archive/6663"),
    EnfRow("株式会社石山組", "2023-12-01", "秋田県", "license_revoke",
           "産業廃棄物処理業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.akita.lg.jp/pages/archive/6663"),
    EnfRow("有限会社湯沢サトー工業", "2023-05-25", "秋田県", "license_revoke",
           "産業廃棄物処理業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.akita.lg.jp/pages/archive/6663"),
    EnfRow("有限会社フジ住建", "2022-11-09", "秋田県", "license_revoke",
           "産業廃棄物処理業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.akita.lg.jp/pages/archive/6663"),
    EnfRow("籾山工業株式会社", "2022-10-26", "秋田県", "license_revoke",
           "産業廃棄物処理業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.akita.lg.jp/pages/archive/6663"),
    EnfRow("有限会社ステップ建設", "2022-04-05", "秋田県", "license_revoke",
           "産業廃棄物処理業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.akita.lg.jp/pages/archive/6663"),
    EnfRow("株式会社北日本重量", "2021-10-22", "秋田県", "license_revoke",
           "産業廃棄物処理業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.akita.lg.jp/pages/archive/6663"),

    # ===== 新潟県 =====
    EnfRow("株式会社木村興産", "2024-08-05", "新潟県", "license_revoke",
           "産業廃棄物処理業 許可取消し。所在地: 新潟県五泉市丸田384番地1",
           _law_env("第14条の3の2第1項"),
           "https://www.pref.niigata.lg.jp/sec/shigenjunkan/1356780448242.html"),
    EnfRow("株式会社信越技研", "2024-09-04", "新潟県", "license_revoke",
           "産業廃棄物処理業 許可取消し。所在地: 新潟県新潟市東区牡丹山四丁目15番8号",
           _law_env("第14条の3の2第1項"),
           "https://www.pref.niigata.lg.jp/sec/shigenjunkan/1356780448242.html"),
    EnfRow("株式会社白井工業所", "2024-10-03", "新潟県", "license_revoke",
           "産業廃棄物処理業 許可取消し。所在地: 新潟県長岡市稽古町1664番地",
           _law_env("第14条の3の2第1項"),
           "https://www.pref.niigata.lg.jp/sec/shigenjunkan/1356780448242.html"),
    EnfRow("株式会社本間建材", "2024-11-20", "新潟県", "license_revoke",
           "産業廃棄物処理業 許可取消し。所在地: 新潟県新発田市島潟1132番地1",
           _law_env("第14条の3の2第1項"),
           "https://www.pref.niigata.lg.jp/sec/shigenjunkan/1356780448242.html"),
    EnfRow("有限会社込山電機", "2025-02-28", "新潟県", "license_revoke",
           "産業廃棄物処理業 許可取消し。所在地: 新潟県新潟市西蒲区曽根1481番地1",
           _law_env("第14条の3の2第1項"),
           "https://www.pref.niigata.lg.jp/sec/shigenjunkan/1356780448242.html"),
    EnfRow("株式会社東栄", "2025-02-28", "新潟県", "license_revoke",
           "産業廃棄物処理業 許可取消し。所在地: 新潟県新発田市舟入町一丁目1番33号",
           _law_env("第14条の3の2第1項"),
           "https://www.pref.niigata.lg.jp/sec/shigenjunkan/1356780448242.html"),

    # ===== 長野県 (産廃) =====
    EnfRow("日本化材株式会社", "2025-12-22", "長野県", "contract_suspend",
    ...
    EnfRow("株式会社大東商事", "2026-03-30", "長野県", "license_revoke",
    ...
    # ===== 三重県 =====
    EnfRow("希望産業有限会社", "2026-03-14", "三重県", "contract_suspend",
           "産業廃棄物処理業 事業の停止",
           _law_env("第14条の3"),
           "https://www.pref.mie.lg.jp/common/01/ci600005204.htm"),
    EnfRow("株式会社チーム一休", "2026-03-13", "三重県", "license_revoke",
           "産業廃棄物処理業 許可の取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.mie.lg.jp/common/01/ci600005204.htm"),
    EnfRow("上山重治", "2026-02-13", "三重県", "license_revoke",
           "産業廃棄物処理業 許可の取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.mie.lg.jp/common/01/ci600005204.htm"),
    EnfRow("株式会社幸組", "2026-01-20", "三重県", "contract_suspend",
           "産業廃棄物処理業 事業の停止",
           _law_env("第14条の3"),
           "https://www.pref.mie.lg.jp/common/01/ci600005204.htm"),
    EnfRow("有限会社中島建材", "2025-12-20", "三重県", "contract_suspend",
           "産業廃棄物処理業 事業の停止",
           _law_env("第14条の3"),
           "https://www.pref.mie.lg.jp/common/01/ci600005204.htm"),
    EnfRow("中村商店株式会社", "2025-12-20", "三重県", "contract_suspend",
           "産業廃棄物処理業 事業の停止",
           _law_env("第14条の3"),
           "https://www.pref.mie.lg.jp/common/01/ci600005204.htm"),
    EnfRow("株式会社植田商店", "2025-03-07", "三重県", "contract_suspend",
           "産業廃棄物処理業 30日間事業停止。プラスチック廃棄物処理マニフェスト虚偽報告",
           _law_env("第14条の3"),
           "https://www.pref.mie.lg.jp/common/01/ci600005204.htm"),

    # ===== 鳥取県 =====
    EnfRow("有限会社いけもと", "2025-12-04", "鳥取県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2第1項第4号"),
           "https://www.pref.tottori.lg.jp/295765.htm"),
    EnfRow("株式会社栗山組", "2024-12-10", "鳥取県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2第1項"),
           "https://www.pref.tottori.lg.jp/295765.htm"),
    EnfRow("有限会社足立道路", "2024-12-05", "鳥取県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2第1項"),
           "https://www.pref.tottori.lg.jp/295765.htm"),
    EnfRow("伊藤実業有限会社", "2023-12-19", "鳥取県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2第1項"),
           "https://www.pref.tottori.lg.jp/295765.htm"),
    EnfRow("有限会社トーケン (鳥取)", "2023-03-03", "鳥取県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し。所在地: 鳥取県鳥取市高住41番地1",
           _law_env("第14条の3の2第1項"),
           "https://www.pref.tottori.lg.jp/295765.htm"),
    EnfRow("駒井利夫", "2026-02-12", "鳥取県", "business_improvement",
           "産業廃棄物撤去 改善命令・措置命令",
           _law_env("第19条の5"),
           "https://www.pref.tottori.lg.jp/295765.htm"),

    # ===== 島根県 =====
    EnfRow("有限会社いけもと (島根)", "2025-12-18", "島根県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し。所在地: 鳥取県米子市吉岡355-1番",
           _law_env("第14条の3の2第1項第4号"),
           "https://www.pref.shimane.lg.jp/infra/kankyo/haiki/sangyo_haikibutsu/gyousei_syobun.html"),
    EnfRow("株式会社幸伸商事", "2026-03-09", "島根県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し。所在地: 兵庫県加西市倉谷町398番地の18",
           _law_env("第14条の3の2第1項第4号"),
           "https://www.pref.shimane.lg.jp/infra/kankyo/haiki/sangyo_haikibutsu/gyousei_syobun.html"),
    EnfRow("株式会社新宮組", "2024-04-23", "島根県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し。所在地: 島根県出雲市多伎町口田儀373番地5",
           _law_env("第14条の3の2第1項第4号"),
           "https://www.pref.shimane.lg.jp/infra/kankyo/haiki/sangyo_haikibutsu/gyousei_syobun.html"),
    EnfRow("有限会社豊栄産業", "2023-12-26", "島根県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し。所在地: 山口県下松市大字東豊井1163番地",
           _law_env("第14条の3の2第1項第4号"),
           "https://www.pref.shimane.lg.jp/infra/kankyo/haiki/sangyo_haikibutsu/gyousei_syobun.html"),
    EnfRow("山陽三共有機株式会社", "2023-12-26", "島根県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し。所在地: 山口県下松市葉山一丁目819番14",
           _law_env("第14条の3の2第1項第4号"),
           "https://www.pref.shimane.lg.jp/infra/kankyo/haiki/sangyo_haikibutsu/gyousei_syobun.html"),
    EnfRow("株式会社宮建", "2022-06-21", "島根県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し。所在地: 出雲市高岡町154番地",
           _law_env("第14条の3の2第1項第1号"),
           "https://www.pref.shimane.lg.jp/infra/kankyo/haiki/sangyo_haikibutsu/gyousei_syobun.html"),
    EnfRow("株式会社道島屋", "2022-11-25", "島根県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し。所在地: 隠岐郡西ノ島町大字浦郷223番地4",
           _law_env("第14条の3の2第1項第1号・第2号"),
           "https://www.pref.shimane.lg.jp/infra/kankyo/haiki/sangyo_haikibutsu/gyousei_syobun.html"),
    EnfRow("有限会社RR9開発", "2022-12-15", "島根県", "license_revoke",
           "特別管理産業廃棄物収集運搬業 許可取消し。所在地: 大田市大田町大田イ313番地9",
           _law_env("第14条の6準用法第14条の3の2第1項第4号"),
           "https://www.pref.shimane.lg.jp/infra/kankyo/haiki/sangyo_haikibutsu/gyousei_syobun.html"),
    EnfRow("有限会社錦織建設", "2022-02-04", "島根県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し。所在地: 出雲市斐川町三分市116番地",
           _law_env("第14条の3の2第1項第1号・第2号"),
           "https://www.pref.shimane.lg.jp/infra/kankyo/haiki/sangyo_haikibutsu/gyousei_syobun.html"),
    EnfRow("有限会社ダイレクト", "2020-07-15", "島根県", "license_revoke",
           "産業廃棄物・特別管理産業廃棄物収集運搬業 許可取消し。所在地: 出雲市湖陵町大池69番地7",
           _law_env("第14条の3の2第1項第4号"),
           "https://www.pref.shimane.lg.jp/infra/kankyo/haiki/sangyo_haikibutsu/gyousei_syobun.html"),
    EnfRow("有限会社新光産業", "2020-09-10", "島根県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し。所在地: 大田市仁摩町仁万1304番地1",
           _law_env("第14条の3の2第1項第2号"),
           "https://www.pref.shimane.lg.jp/infra/kankyo/haiki/sangyo_haikibutsu/gyousei_syobun.html"),
    EnfRow("株式会社ヤマダエコソリューション", "2021-01-05", "島根県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し。所在地: 福岡県福岡市博多区美野島三丁目1番5号",
           _law_env("第14条の3の2第1項第4号"),
           "https://www.pref.shimane.lg.jp/infra/kankyo/haiki/sangyo_haikibutsu/gyousei_syobun.html"),
    EnfRow("西村誠", "2014-09-18", "島根県", "business_improvement",
           "改善命令。不適正処理廃棄物の速やかな撤去と適正処理。所在地: 出雲市大社町杵築西1957番地",
           _law_env("第12条第1項"),
           "https://www.pref.shimane.lg.jp/infra/kankyo/haiki/sangyo_haikibutsu/gyousei_syobun.html"),

    # ===== 香川県 =====
    EnfRow("土讃総業株式会社", "2025-05-29", "香川県", "license_revoke",
    ...
    EnfRow("有限会社池田組", "2025-06-17", "香川県", "license_revoke",
    ...
    EnfRow("有限会社増田工務店", "2025-08-20", "香川県", "license_revoke",
    ...
    # ===== 高知県 =====
    EnfRow("株式会社香香", "2026-04-09", "高知県", "contract_suspend",
           "無許可で一般廃棄物・産業廃棄物の収集運搬・処分業を営業、10日間の業務停止処分（2026-04-09 ~ 2026-04-18）",
           _law_env("第14条の3"),
           "https://www.pref.kochi.lg.jp/press1/2026033000051/"),
    EnfRow("有限会社清岡建工", "2025-12-11", "高知県", "contract_suspend",
           "建設廃材の野外焼却 10日間の業務停止処分",
           _law_env("第14条の3 / 第16条の2"),
           "https://www.pref.kochi.lg.jp/press1/2025121100048/"),
    EnfRow("合同会社みかづき", "2025-02-06", "高知県", "contract_suspend",
           "無許可で一般廃棄物を収集運搬、業務停止処分",
           _law_env("第14条の3"),
           "https://www.pref.kochi.lg.jp/press1/2025020600021/"),

    # ===== 佐賀県 =====
    EnfRow("株式会社和城建設", "2025-10-22", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("株式会社久富重機", "2025-09-01", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("株式会社八幡ビルエンジニアリング (佐賀)", "2025-03-31", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業及び特別管理産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("庄野崎徹二", "2024-06-05", "佐賀県", "license_revoke",
           "産業廃棄物処理施設の設置許可 取消し",
           _law_env("第15条の3"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("株式会社エムズ", "2024-04-18", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("株式会社エイトエンジニアリング", "2023-06-28", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("チッキ株式会社", "2023-06-07", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("ヤマヒロ工業株式会社", "2023-05-10", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("株式会社シンワ・コーポレーション", "2023-12-08", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("川井工業有限会社", "2024-02-13", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("有限会社相互オガ粉クリーン", "2023-03-29", "佐賀県", "license_revoke",
           "複数許可の取消（収集運搬業・処分業・処理施設）",
           _law_env("第14条の3の2 / 第15条の3"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("大勝建設株式会社", "2022-08-22", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("株式会社センク", "2022-07-20", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("有限会社伊藤土木建設", "2022-02-15", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("大西化成株式会社", "2021-11-25", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("株式会社翔輝", "2021-10-29", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("有限会社リー", "2021-10-07", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("株式会社大祥", "2021-08-27", "佐賀県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消し",
           _law_env("第14条の3の2"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),
    EnfRow("庄野崎徹二 (佐賀)", "2023-10-20", "佐賀県", "business_improvement",
           "産業廃棄物処理施設の改善命令、使用停止命令",
           _law_env("第15条の2の7"),
           "https://www.pref.saga.lg.jp/kiji00314085/index.html"),

    # ===== 大分県 =====
    EnfRow("Suicorporation株式会社", "2020-03-17", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("株式会社大輝興業", "2020-04-13", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("株式会社建匠社", "2020-06-22", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("株式会社M&Aトランスポート", "2020-09-24", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("株式会社BIRD", "2020-11-19", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("株式会社九州冷鮮輸送", "2020-12-10", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("有限会社アドバンテージ物流サービス", "2021-05-17", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("株式会社三共商会 (大分)", "2021-05-17", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("有限会社翔樹", "2021-06-08", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("株式会社タカハシ", "2022-03-25", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("上田産業株式会社", "2022-03-28", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("有限会社ナショナル建設", "2022-07-14", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("有限会社サイガン工業", "2022-09-02", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("有限会社臼杵総建", "2023-01-26", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("株式会社大分メタルズ", "2023-03-15", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("株式会社R (大分)", "2023-06-15", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("小まわり商會有限会社", "2023-09-21", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("有限会社山末建設", "2024-06-12", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("佐伯建工株式会社", "2024-08-09", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("株式会社藤信", "2024-08-09", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),
    EnfRow("株式会社八幡ビルエンジニアリング (大分)", "2025-03-27", "大分県", "license_revoke",
           "産業廃棄物処理業 許可の取消し", _law_env("第14条の3の2"),
           "https://www.pref.oita.jp/soshiki/13400/gyosei-syobun.html"),

    # ===== 宮崎県 =====
    EnfRow("株式会社WARAKU", "2025-09-26", "宮崎県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消", _law_env("第14条の3の2"),
           "http://www.pref.miyazaki.lg.jp/junkansuishin/kurashi/shizen/page00124.html"),
    EnfRow("有限会社エスアイシー産業", "2025-09-17", "宮崎県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消", _law_env("第14条の3の2"),
           "http://www.pref.miyazaki.lg.jp/junkansuishin/kurashi/shizen/page00124.html"),
    EnfRow("株式会社TATSUKI", "2025-09-17", "宮崎県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消", _law_env("第14条の3の2"),
           "http://www.pref.miyazaki.lg.jp/junkansuishin/kurashi/shizen/page00124.html"),
    EnfRow("株式会社松葉総業", "2025-07-18", "宮崎県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消", _law_env("第14条の3の2"),
           "http://www.pref.miyazaki.lg.jp/junkansuishin/kurashi/shizen/page00124.html"),
    EnfRow("株式会社セイコー環境 (宮崎)", "2025-05-29", "宮崎県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消", _law_env("第14条の3の2"),
           "http://www.pref.miyazaki.lg.jp/junkansuishin/kurashi/shizen/page00124.html"),
    EnfRow("株式会社八幡ビルエンジニアリング (宮崎)", "2025-05-21", "宮崎県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消", _law_env("第14条の3の2"),
           "http://www.pref.miyazaki.lg.jp/junkansuishin/kurashi/shizen/page00124.html"),
    EnfRow("マテリアルセンター有限会社", "2025-03-28", "宮崎県", "contract_suspend",
           "産業廃棄物収集運搬及び処分業 90日間事業停止", _law_env("第14条の3"),
           "http://www.pref.miyazaki.lg.jp/junkansuishin/kurashi/shizen/page00124.html"),
    EnfRow("有限会社大山産業", "2024-05-14", "宮崎県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消", _law_env("第14条の3の2"),
           "http://www.pref.miyazaki.lg.jp/junkansuishin/kurashi/shizen/page00124.html"),
    EnfRow("株式会社R (宮崎)", "2023-07-25", "宮崎県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消", _law_env("第14条の3の2"),
           "http://www.pref.miyazaki.lg.jp/junkansuishin/kurashi/shizen/page00124.html"),
    EnfRow("児湯養鶏農業協同組合", "2023-06-29", "宮崎県", "license_revoke",
           "産業廃棄物処分業・収集運搬業 許可取消", _law_env("第14条の3の2"),
           "http://www.pref.miyazaki.lg.jp/junkansuishin/kurashi/shizen/page00124.html"),
    EnfRow("南部廃棄物処理事業協同組合", "2022-11-17", "宮崎県", "license_revoke",
           "処分施設設置許可 取消", _law_env("第15条の3"),
           "http://www.pref.miyazaki.lg.jp/junkansuishin/kurashi/shizen/page00124.html"),
    EnfRow("TOA株式会社", "2022-10-14", "宮崎県", "license_revoke",
           "一般・産業廃棄物処理施設設置許可 取消", _law_env("第15条の3"),
           "http://www.pref.miyazaki.lg.jp/junkansuishin/kurashi/shizen/page00124.html"),

    # ===== 鹿児島県 =====
    EnfRow("村上建設株式会社", "2025-12-11", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消(04607035719号)。所在地: 鹿児島県奄美市名瀬小浜町",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("丸紅解体株式会社", "2025-11-21", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業・処分業 許可取消。所在地: 鹿児島県鹿屋市大浦町",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("株式会社セイコー環境 (鹿児島)", "2025-08-06", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消(04611120421号)。所在地: 鹿児島県姶良市蒲生町",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("株式会社八幡ビルエンジニアリング (鹿児島)", "2025-07-23", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消(04609116671号)。所在地: 福岡県北九州市八幡西区",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("株式会社田川組", "2025-06-20", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消(04607117839号)。所在地: 鹿児島県鹿児島市荒田二丁目",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("株式会社中馬", "2025-03-31", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業・処分業 許可取消。所在地: 鹿児島県いちき串木野市",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("共同組海運株式会社", "2025-03-04", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業・特別管理収集運搬業 許可取消。所在地: 鹿児島県鹿児島市谷山港",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("有限会社永田鋼管工業", "2024-09-18", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消(04606179653号)。所在地: 鹿児島県鹿児島市春山町",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("株式会社末廣ハツリ建設興業", "2024-08-19", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消(04606179033号)。所在地: 鹿児島県鹿児島市皆与志町",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("株式会社川崎工業", "2023-11-02", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消(04600145891号)。所在地: 鹿児島県曽於市大隅町",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("株式会社晴伝社", "2023-11-01", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消(04605205315号)。所在地: 福岡県福岡市博多区那珂三丁目",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("株式会社R (鹿児島)", "2023-07-03", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消(04609197890号)。所在地: 福岡県大川市大字北古賀",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("株式会社CORE", "2023-07-03", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消(04604225065号)。所在地: 福岡県大川市大字向島",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("株式会社姶良産業", "2022-07-01", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業・処分業 許可取消。所在地: 鹿児島県姶良市加治木町",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("合資会社起運送", "2022-06-10", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消(04609195346号)。所在地: 鹿児島県大島郡徳之島町",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),
    EnfRow("有限会社下木原建設", "2022-03-25", "鹿児島県", "license_revoke",
           "産業廃棄物収集運搬業 許可取消(04618192739号)。所在地: 鹿児島県枕崎市木原町",
           _law_env("第14条の3の2"),
           "http://www.pref.kagoshima.jp/ad03/kurashi-kankyo/recycle/sanpai/torikesi.html"),

    # ===== 福島県 産廃 =====
    EnfRow("SHOWA株式会社", "2025-11-26", "福島県", "license_revoke",
           "産業廃棄物処理業 許可取消", _law_env("第14条の3の2"),
           "http://www.pref.fukushima.lg.jp/sec/16045b/haikibutsutaisaku047.html"),
    EnfRow("草野工業株式会社", "2025-08-07", "福島県", "license_revoke",
           "産業廃棄物処理業 許可取消", _law_env("第14条の3の2"),
           "http://www.pref.fukushima.lg.jp/sec/16045b/haikibutsutaisaku047.html"),
    EnfRow("有限会社さくら造園緑地", "2025-06-03", "福島県", "license_revoke",
           "産業廃棄物処理業 許可取消", _law_env("第14条の3の2"),
           "http://www.pref.fukushima.lg.jp/sec/16045b/haikibutsutaisaku047.html"),

    # ===== 岐阜県 =====
    EnfRow("株式会社ワイティ建設", "2004-04-30", "岐阜県", "business_improvement",
           "建設系廃棄物過剰保管 改善命令。所在地: 瑞穂市本田434番地の1他",
           _law_env("第19条の3"),
           "https://www.pref.gifu.lg.jp/page/3644.html"),
    EnfRow("有限会社真和洋行", "2011-08-19", "岐阜県", "business_improvement",
           "スラッジ不法投棄 措置命令。所在地: 養老町蛇持新栄298番地の5",
           _law_env("第19条の5"),
           "https://www.pref.gifu.lg.jp/page/3644.html"),
    EnfRow("株式会社川本商事", "2023-07-10", "岐阜県", "business_improvement",
           "建設系廃棄物放置 措置命令。所在地: 養老町小倉字中山1418番20他",
           _law_env("第19条の5"),
           "https://www.pref.gifu.lg.jp/page/3644.html"),
    EnfRow("ハウジング藤田株式会社", "2006-12-04", "岐阜県", "business_improvement",
           "廃タイヤ放置 措置命令。所在地: 揖斐川町谷汲名礼大平1035番地の75他",
           _law_env("第19条の5"),
           "https://www.pref.gifu.lg.jp/page/3644.html"),
    EnfRow("有限会社キヨス合成リサイクルセンター", "2002-11-18", "岐阜県", "business_improvement",
           "廃パチンコ台放置 改善命令。所在地: 東白川村五加地内",
           _law_env("第19条の3"),
           "https://www.pref.gifu.lg.jp/page/3644.html"),
    EnfRow("有限会社鳶森組", "1998-02-25", "岐阜県", "business_improvement",
           "廃プラスチック放置 措置命令。所在地: 美濃市曽代1109番地の1他",
           _law_env("第19条の5"),
           "https://www.pref.gifu.lg.jp/page/3644.html"),
    EnfRow("西村建設", "2004-06-08", "岐阜県", "business_improvement",
           "建設系廃棄物過剰保管 改善命令。所在地: 瑞浪市陶町他複数地点",
           _law_env("第19条の3"),
           "https://www.pref.gifu.lg.jp/page/3644.html"),
    EnfRow("名古屋シーベル有限会社", "2007-01-11", "岐阜県", "business_improvement",
           "古畳放置 措置命令。所在地: 瑞浪市日吉町蟹ヶ窪7736番地の43他",
           _law_env("第19条の5"),
           "https://www.pref.gifu.lg.jp/page/3644.html"),
    EnfRow("株式会社ナカヤマ", "2002-12-12", "岐阜県", "business_improvement",
           "焼却灰放置 改善命令。所在地: 高山市丹生川町町方寺社ケ洞3478番地の1他",
           _law_env("第19条の3"),
           "https://www.pref.gifu.lg.jp/page/3644.html"),

    # ===== 仙台市 =====
    EnfRow("株式会社ジャパンクリーン", "2025-10-17", "仙台市", "license_revoke",
    ...
    # ===== 介護/障害福祉 (kaigo_shogai) =====
    EnfRow("HITOWAケアサービス株式会社", "2026-02-06", "長野県", "business_improvement",
    ...
    EnfRow("合同会社きずなグループ進", "2026-04-30", "長野県", "license_revoke",
    ...
    EnfRow("熊本県内某事業者 (令和2年3月31日 取消)", "2020-03-31", "熊本県", "license_revoke",
           "介護保険法に基づく指定の取消し処分",
           _law_kaigo("第77条"),
           "https://www.pref.kumamoto.jp/kiji_32055.html"),
    # 愛媛県 障害福祉 行政処分 (PDF, dates only)
    EnfRow("愛媛県内 障害福祉 取消事業者 (R8.1.28)", "2026-01-28", "愛媛県", "license_revoke",
           "指定障害福祉サービス事業者の指定取消し",
           _law_shogai("第50条"),
           "https://www.pref.ehime.jp/page/6004.html"),
    EnfRow("愛媛県内 障害福祉 取消事業者 (R7.3.25)", "2025-03-25", "愛媛県", "license_revoke",
           "指定障害福祉サービス事業者の指定取消し",
           _law_shogai("第50条"),
           "https://www.pref.ehime.jp/page/6004.html"),
    EnfRow("愛媛県内 障害福祉 取消事業者 (R6.8.9)", "2024-08-09", "愛媛県", "license_revoke",
           "指定障害福祉サービス事業者の指定取消し",
           _law_shogai("第50条"),
           "https://www.pref.ehime.jp/page/6004.html"),
    EnfRow("愛媛県内 障害福祉 取消事業者 (R6.5.29)", "2024-05-29", "愛媛県", "license_revoke",
           "指定障害福祉サービス事業者の指定取消し",
           _law_shogai("第50条"),
           "https://www.pref.ehime.jp/page/6004.html"),
    EnfRow("愛媛県内 障害福祉 取消事業者 (R5.5.11)", "2023-05-11", "愛媛県", "license_revoke",
           "指定障害福祉サービス事業者の指定取消し",
           _law_shogai("第50条"),
           "https://www.pref.ehime.jp/page/6004.html"),
    EnfRow("愛媛県内 障害福祉 取消事業者 (R4.3.30)", "2022-03-30", "愛媛県", "license_revoke",
           "指定障害福祉サービス事業者の指定取消し",
           _law_shogai("第50条"),
           "https://www.pref.ehime.jp/page/6004.html"),
    EnfRow("愛媛県内 障害福祉 改善命令事業者A (R7.12.11)", "2025-12-11", "愛媛県", "business_improvement",
           "指定障害福祉サービス事業者の改善命令",
           _law_shogai("第49条"),
           "https://www.pref.ehime.jp/page/6004.html"),
    EnfRow("愛媛県内 障害福祉 改善命令事業者B (R7.12.11)", "2025-12-11", "愛媛県", "business_improvement",
           "指定障害福祉サービス事業者の改善命令",
           _law_shogai("第49条"),
           "https://www.pref.ehime.jp/page/6004.html"),
    EnfRow("青森県内 介護事業者 取消事例 (令和3年3月)", "2021-03-31", "青森県", "license_revoke",
...
PLACEHOLDER_PUBLIC_PAGES: list[tuple[str, str, str]] = [
    # (authority, url, note)
    ("青森県", "https://www.pref.aomori.lg.jp/release/2023/73728.html",
     "産業廃棄物処理業者に対する不利益処分（許可取消）"),
    ("山梨県", "https://www.pref.yamanashi.jp/kankyo-sb/14591440835.html",
     "行政処分リスト【処理業者】令和8年3月30日現在 PDF 集約"),
    ("山口県", "https://www.pref.yamaguchi.lg.jp/press/294261.html",
     "産業廃棄物処理業者に対する行政処分（無許可委託の許可取消）"),
    ("徳島県", "https://www.pref.tokushima.lg.jp/ippannokata/kurashi/recycling/5046010/",
     "藤本一男 (令和3年4月9日) 産業廃棄物収集運搬業 許可取消(廃棄物処理法第14条の3の2)"),
    ("愛媛県", "https://www.pref.ehime.jp/page/130250.html",
     "産業廃棄物処理業者に対する行政処分 PDF 集約"),
    ("北九州市", "https://www.city.kitakyushu.lg.jp/kankyou/00900062.html",
     "産業廃棄物処理業者等に対する行政処分公表ページ"),
    ("川崎市", "https://www.city.kawasaki.jp/300/cmsfiles/contents/0000013/13670/R061001furiekisyobunn.pdf",
     "川崎市産業廃棄物処理業行政処分一覧 PDF"),
    ("浜松市", "https://www.city.hamamatsu.shizuoka.jp/sanpai/haiki/fuhotoki/ihanjirei.html",
     "浜松市内における最近の検挙等事例（行政処分含む）"),
    ("静岡県", "https://www.pref.shizuoka.jp/kensei/introduction/soshiki/1002382/1002546/1017709.html",
     "廃棄物リサイクル課行政処分公表（令和2~7年度PDF集約）"),
    ("福島県", "https://www.pref.fukushima.lg.jp/sec/21025b/kaigo-syobun.html",
...
for auth, url, note in PLACEHOLDER_PUBLIC_PAGES:
    SEED_ROWS.append(
        EnfRow(
            ...
            reason_summary=note,
            related_law_ref=(
                _law_kaigo() if "介護" in note else _law_env()
            ),
            source_url=url,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        for r in SEED_ROWS:
            ...
            try:
                ...
                _LOG.error("DB error name=%r date=%s: %s",
    ...
    _LOG.info(
        ...
        stats["rows_total"], stats["rows_inserted"],
