...
SEED_ROWS: list[EnfRow] = [
    ...
    EnfRow("株式会社トーシン", "2026-01-27", "東京都", "license_revoke",
    ...
    EnfRow("有限会社酒井興業", "2024-08-27", "東京都", "license_revoke",
    ...
    EnfRow("株式会社エクスクローザー", "2024-12-12", "東京都", "license_revoke",
    ...
    EnfRow("株式会社大萩造園", "2024-02-29", "東京都", "license_revoke",
    ...
    EnfRow("株式会社都木材緑化", "2026-03-10", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 森﨑修身。所在地: 神奈川県相模原市緑区城山四丁目11番1号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("美貴建設株式会社", "2026-01-16", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 中沢美枝子。所在地: 東京都足立区東綾瀬三丁目2番12号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社カーズ", "2026-01-15", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 家高竜平。所在地: 東京都葛飾区水元五丁目11番24号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社恵興", "2025-11-26", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 辻子恵介。所在地: 東京都港区芝公園二丁目12番17号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社永利建設工業", "2025-11-11", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 江田毅。所在地: 東京都葛飾区お花茶屋一丁目7番4号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社トーシン", "2025-10-20", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業及び特別管理産業廃棄物収集運搬業の許可取消し。代表者: 柴山東。所在地: 東京都練馬区西大泉六丁目14番-5",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("dbクリーン株式会社", "2025-10-18", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 青栁未希。所在地: 埼玉県越谷市七左町4-15-10",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("ウエストファクトリィ株式会社", "2025-06-26", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 山本そのみ。所在地: 東京都中央区銀座一丁目27番11号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("宇野興業合同会社", "2025-06-18", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 劉野。所在地: 東京都足立区伊興本町二丁目12番29号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("塚田龍偉", "2025-06-17", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。所在地: 神奈川県横浜市鶴見区下末吉三丁目3番17号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("有限会社松島組", "2025-05-19", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 松島廣。所在地: 栃木県小山市城北四丁目26番地24",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社オチアイ", "2025-05-17", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 落合孝義。所在地: 神奈川県茅ヶ崎市旭が丘8番22号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社山友興業", "2025-05-09", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 山下友輔。所在地: 千葉県八千代市麦丸1111番地1",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社ユウキ", "2025-05-07", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 諸岡真由美。所在地: 埼玉県川口市芝中田一丁目25番3",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社川口組", "2025-05-01", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。所在地: 埼玉県越谷市蒲生本町2番24号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社令幸", "2025-04-29", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 上野武彦。所在地: 東京都江戸川区船堀二丁目4番28号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("奥田技研株式会社", "2025-04-03", "神奈川県", "license_revoke",
           "特別管理産業廃棄物収集運搬業の許可取消し。代表者: 奥田勇。所在地: 神奈川県川崎市宮前区初山二丁目10番11号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社エコトップ", "2025-01-26", "神奈川県", "license_revoke",
           "産業廃棄物処分業の許可取消し。代表者: 荻野晃彦。所在地: 神奈川県座間市広野台二丁目6番18号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社ショーナン", "2025-01-20", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 下川隆太。所在地: 大阪府門真市速見町2番12号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社渋谷緑建", "2024-10-09", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 桒原禎樹。所在地: 神奈川県横浜市泉区和泉中央北四丁目1番9号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("杉山建設株式会社", "2024-09-19", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 杉山弘樹。所在地: 神奈川県藤沢市城南一丁目18番5号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社スマイルパートナー", "2024-09-03", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 伊藤友哉。所在地: 千葉県千葉市若葉区都賀三丁目17番5号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社ユースタイル", "2024-09-03", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 大津孝彰。所在地: 千葉県八街市東吉田517番地18",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社吉岡開発", "2024-06-24", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 吉岡龍一。所在地: 東京都足立区南花畑五丁目8番6-203号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("ホーコー産業株式会社", "2024-06-04", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 斉藤充。所在地: 神奈川県横浜市都筑区折本町1493番地1",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("幸伸工業株式会社", "2024-05-08", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 廣瀨和義。所在地: 神奈川県川崎市幸区北加瀬一丁目10番12号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("宝建工業株式会社", "2024-05-08", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 枝並留理。所在地: 神奈川県川崎市幸区北加瀬二丁目5番35号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("有限会社上下水管理工業", "2024-04-23", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 鈴木俊明。所在地: 神奈川県横浜市神奈川区台町13番地17",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社大萩造園", "2024-03-26", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 萩原昌也。所在地: 神奈川県相模原市中央区富士見六丁目15番19号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社横浜総建", "2024-02-21", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 秦洪海。所在地: 神奈川県横浜市泉区上飯田町2670番地",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("有限会社大貫解体工業", "2024-02-21", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 大貫始康。所在地: 東京都八王子市小比企町536番地の37",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("川崎工苑建設株式会社", "2024-01-25", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 目代洋子。所在地: 神奈川県川崎市宮前区馬絹三丁目16番23号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("有限会社奥山興業", "2024-01-23", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 奥山富士雄。所在地: 神奈川県茅ヶ崎市本宿町11番46-409号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("大成鉱業株式会社", "2023-12-15", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 上田博明。所在地: 神奈川県横浜市旭区本宿町22番地",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("有限会社鳶芳建設", "2023-10-26", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 角田芳一。所在地: 神奈川県藤沢市渡内五丁目2番地の7",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社日彩", "2023-09-11", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 友松大輔。所在地: 埼玉県北葛飾郡杉戸町才羽1477番地",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社東京高英", "2023-08-24", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 岸本惇。所在地: 埼玉県新座市馬場一丁目11番20号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("アイエス株式会社", "2023-05-16", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: イシアルプ。所在地: 埼玉県川口市大字安行領根岸856番地",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社正建", "2023-04-18", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 似鳥正昭。所在地: 神奈川県川崎市宮前区水沢三丁目4番33-1号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("有限会社ケイハツ", "2023-04-18", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 丸峯司。所在地: 東京都羽村市羽4142番地1",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("柏原建設株式会社", "2023-03-03", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 柏原亮。所在地: 神奈川県横浜市港南区野庭町659番地17",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("藤本土木サービス有限会社", "2023-02-16", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 藤本卓士。所在地: 東京都清瀬市下宿一丁目122番地",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社ウッドアップ", "2023-02-03", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: エレン・オザルプ。所在地: 神奈川県横浜市旭区三反田町字長谷戸86-1",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("北見工業株式会社", "2023-01-04", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 北見文則。所在地: 埼玉県さいたま市中央区上峰一丁目20番16号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社ネクスト", "2023-01-04", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 岸真。所在地: 東京都武蔵村山市学園一丁目24番地の8",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("サガミ環境事業株式会社", "2022-09-06", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 天野研史。所在地: 神奈川県平塚市東中原二丁目2番73号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社緑生", "2022-08-08", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 加藤沙織。所在地: 神奈川県横須賀市武四丁目8番1号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("有限会社三栄", "2022-04-22", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 山本展子。所在地: 神奈川県川崎市多摩区登戸3478番地1",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("有限会社池見造園", "2022-04-08", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 池見和弘。所在地: 神奈川県相模原市中央区上溝4509番地26",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("雄美建設株式会社", "2022-03-24", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 矢本広幸。所在地: 神奈川県伊勢原市東大竹二丁目8番12号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("浜一運送株式会社", "2022-03-09", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 田島和夫。所在地: 神奈川県横浜市金沢区鳥浜町1番地の1",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("誠工株式会社", "2022-03-07", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 城川誠。所在地: 兵庫県神戸市兵庫区大開通二丁目3番21号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("首都圏サポート株式会社", "2022-03-07", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 松永篤。所在地: 東京都目黒区五本木三丁目16番10号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("有限会社前田緑化土木", "2022-01-31", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 前田好雄。所在地: 神奈川県伊勢原市板戸127番地の2",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社KOHWA", "2021-08-30", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 岸備。所在地: 神奈川県相模原市中央区南橋本四丁目3番27号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("石井建設株式会社", "2021-06-28", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 石井敬二。所在地: 山梨県上野原市棡原63番地",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社エムエスプランニング", "2021-05-14", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: 佐山学。所在地: 神奈川県横浜市金沢区能見台通34番25号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("八木周太", "2021-03-18", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。所在地: 神奈川県藤沢市羽鳥5丁目7番19号",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),
    EnfRow("株式会社ウルジャポン", "2021-03-18", "神奈川県", "license_revoke",
           "産業廃棄物収集運搬業の許可取消し。代表者: メフメット・タシ。所在地: 埼玉県川口市赤芝新田字道上507番地の1",
           f"{DEFAULT_LAW} 第14条の3の2", "https://www.pref.kanagawa.jp/docs/p3k/cnt/f91/index.html"),

    # ===== 広島県 (eco広島 過去5年間) =====
    EnfRow("株式会社桐光", "2025-10-17", "広島県", "license_revoke",
    ...
    EnfRow("有限会社大森産業", "2025-07-02", "広島県", "license_revoke",
           "処理業取消し（収集運搬業、特管収集運搬業、処分業）。役員が処理法違反罰金刑及び拘禁刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("渡部建設株式会社", "2024-04-18", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の処理法違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社イハラ", "2025-01-08", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の処理法違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社山下産業", "2022-12-27", "広島県", "license_revoke",
           "処理業取消し（収集運搬業、処分業）。役員の処理法違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社北海", "2022-08-19", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の拘禁刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("有限会社ゼロ", "2022-08-04", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の拘禁刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社オタル解体工業", "2021-12-07", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の焼却禁止違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第16条の2 / 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("拓也実業株式会社", "2021-12-03", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の焼却禁止違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第16条の2 / 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("有限会社赤石工業", "2021-11-05", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の焼却禁止違反罰金刑及び拘禁刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第16条の2 / 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("有限会社北成興業", "2021-10-08", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の取消。業者及び役員の焼却禁止違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第16条の2 / 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社北日本重量", "2021-10-06", "広島県", "license_revoke",
           "処理業取消し（収集運搬業、特管収集運搬業）。役員の拘禁刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("有限会社難波重機", "2021-08-11", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の取消。業者及び役員の焼却禁止違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第16条の2 / 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("有限会社やまいち", "2021-04-30", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の処理法違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("宮工建株式会社", "2021-03-04", "広島県", "license_revoke",
    ...
    EnfRow("株式会社山下産業", "2022-12-27", "広島県", "license_revoke",
           ...
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html",
           extras={"distinct": "shisetsu"}),
    EnfRow("株式会社森剛", "2022-02-16", "広島県", "contract_suspend",
           "産業廃棄物処理施設の使用停止及び改善（R4.4.7解除）",
           f"{DEFAULT_LAW} 第15条の2の7",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社藤井商店", "2022-03-11", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社大誠", "2022-04-26", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社デンキョウ", "2022-12-14", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社大西建設工業", "2023-01-17", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社森剛", "2023-03-08", "広島県", "contract_suspend",
           "産業廃棄物処理施設の使用停止及び改善（R5.5.19解除）",
           f"{DEFAULT_LAW} 第15条の2の7",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社セイテツ", "2023-06-22", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("有限会社豊栄産業", "2023-12-27", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("山陽三共有機株式会社", "2023-12-27", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("三次振興企業株式会社", "2024-01-26", "広島県", "contract_suspend",
           "産業廃棄物処理施設の使用停止及び改善（R6.2.22解除）",
           f"{DEFAULT_LAW} 第15条の2の7",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("村上恭子", "2024-02-06", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("有限会社須賀解体", "2024-02-20", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("岩本鋼材株式会社", "2024-03-21", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社ハンディマン", "2024-08-28", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("有限会社清勝園", "2024-10-25", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("有限会社貞尾興業", "2024-11-15", "広島県", "license_revoke",
           "産業廃棄物収集運搬業及び特別管理産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("吉田順介", "2024-12-26", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社Ready Lyn", "2025-03-27", "広島県", "contract_suspend",
           "産業廃棄物収集運搬業の全部停止、特別管理産業廃棄物収集運搬業の全部停止（R7.6.25まで）",
           f"{DEFAULT_LAW} 第14条の3",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("久保田蓮", "2025-08-08", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("大洋物産株式会社", "2025-12-03", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("岡山産興株式会社", "2025-12-03", "広島県", "contract_suspend",
           "産業廃棄物処理施設の使用停止及び改善（R8.1.28解除）",
           f"{DEFAULT_LAW} 第15条の2の7",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社渡辺工業所", "2025-12-04", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("因島金属株式会社", "2026-01-08", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("株式会社坂本建設", "2026-02-06", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),
    EnfRow("竹下慎吾", "2026-04-17", "広島県", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hiroshima.lg.jp/site/eco/i-i2-shobun-shobun.html"),

    # 広島市 press release
    EnfRow("蔵前産業有限会社", "2021-06-30", "広島市", "license_revoke",
           "産業廃棄物収集運搬業の許可の取消し（許可番号07310003165）。役員が法第16条の2（焼却禁止）違反で罰金20万円判決確定",
           f"{DEFAULT_LAW} 第16条の2 / 第14条の3の2",
           "https://www.city.hiroshima.lg.jp/houdou/houdou/232608.html"),

    # ===== 北海道 =====
    EnfRow("株式会社桐光", "2025-10-17", "北海道", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員が廃棄物処理法違反で罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("有限会社大森産業（北海道）", "2025-07-02", "北海道", "license_revoke",
           "処理業取消し（収集運搬業、特管収集運搬業、処分業）。役員が処理法違反罰金刑及び拘禁刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("渡部建設株式会社", "2024-04-18", "北海道", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の処理法違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("株式会社イハラ", "2025-01-08", "北海道", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の処理法違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("株式会社山下産業（北海道）", "2022-12-27", "北海道", "license_revoke",
           "処理業取消し（収集運搬業、処分業）。役員の処理法違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("株式会社北海", "2022-08-19", "北海道", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の拘禁刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("有限会社ゼロ", "2022-08-04", "北海道", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の拘禁刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("株式会社オタル解体工業", "2021-12-07", "北海道", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の焼却禁止違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第16条の2 / 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("拓也実業株式会社（北海道）", "2021-12-03", "北海道", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の焼却禁止違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第16条の2 / 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("有限会社赤石工業", "2021-11-05", "北海道", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の焼却禁止違反罰金刑及び拘禁刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第16条の2 / 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("有限会社北成興業", "2021-10-08", "北海道", "license_revoke",
           "産業廃棄物収集運搬業の取消。業者及び役員の焼却禁止違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第16条の2 / 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("株式会社北日本重量", "2021-10-06", "北海道", "license_revoke",
           "処理業取消し（収集運搬業、特管収集運搬業）。役員の拘禁刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("有限会社難波重機", "2021-08-11", "北海道", "license_revoke",
           "産業廃棄物収集運搬業の取消。業者及び役員の焼却禁止違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第16条の2 / 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("有限会社やまいち", "2021-04-30", "北海道", "license_revoke",
           "産業廃棄物収集運搬業の取消。役員の処理法違反罰金刑確定により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("有限会社厚田環境センター", "2004-11-12", "北海道", "business_improvement",
           "改善命令: 堆積廃棄物撤去、上限超過廃棄物処理、水質測定実施、焼却炉構造改善。最終処分場上に約21,000m³堆積、保管上限超過、測定未実施、構造基準不適合",
           f"{DEFAULT_LAW} 第19条の3",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),
    EnfRow("株式会社キーアイ", "2014-10-02", "北海道", "business_improvement",
           "改善命令: 保管数量を296.67m³以下に削減。事業場内で約4,600m³を保管上限296.67m³超過で保管",
           f"{DEFAULT_LAW} 第19条の3",
           "https://www.pref.hokkaido.lg.jp/ks/jss/sanpai_1/syobun_kouhyou/jyoukyou3.html"),

    # ===== 千葉県 (press releases) =====
    EnfRow("株式会社ダイコウ", "2025-03-04", "千葉県", "license_revoke",
    ...
    EnfRow("株式会社セフティランド", "2025-01-20", "千葉県", "contract_suspend",
    ...
    EnfRow("株式会社新日本オゾン", "2026-02-17", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社ジャパンクリーン", "2026-01-29", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社ASUKA", "2025-12-22", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("クローバー建設株式会社", "2025-11-26", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("有限会社林材木店", "2025-10-23", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社H産業", "2025-10-10", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社ベストワーク", "2025-10-08", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("有限会社西満商事", "2025-09-04", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社サングリーン", "2025-09-02", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("渡辺工業株式会社", "2025-08-18", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社トーシン", "2025-08-06", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("磐梯興業株式会社", "2025-07-28", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("大渕建設株式会社", "2025-07-10", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("有限会社松島組", "2025-06-16", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("合同会社葵組", "2025-06-05", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("有限会社大槻ポンプ", "2025-05-22", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社山友興業", "2025-05-20", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("宇野興業合同会社", "2025-04-18", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("川南鋼機株式会社", "2025-02-28", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社北陽", "2025-02-22", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社T.K.S", "2025-02-13", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社吉野建設興業", "2024-12-09", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社SHIMADA", "2024-12-04", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社蜂谷興業", "2024-09-08", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社岡野工務店", "2024-06-26", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("東建株式会社", "2024-04-12", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社イーズ", "2024-03-28", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("有限会社新解", "2024-03-01", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("有限会社丸孝商事", "2024-02-13", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社ジョイクス", "2024-02-01", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("砂押プラリ株式会社", "2024-02-01", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社梅沢工務店", "2024-01-23", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("ニッポー工業株式会社", "2023-12-27", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("島田建設株式会社", "2023-12-22", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("有限会社田村商店", "2023-08-26", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社長岡商会", "2023-08-03", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社アトラス産業", "2023-08-02", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社Basis", "2023-08-01", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社リベルテプランニング", "2023-04-03", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("東日本クリーンサービス株式会社", "2023-02-28", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社ゼットライン", "2023-02-10", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("有限会社五月造園", "2023-01-21", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("大輝工業合同会社", "2023-01-18", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社シュウワエンジニアリング", "2022-10-31", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("ワークエクスプレス株式会社", "2022-10-11", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("越谷金属株式会社", "2022-10-11", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社一越組", "2022-09-20", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社菊地造園土木", "2022-09-07", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社JRCコーポレーション", "2022-07-20", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社一大", "2022-06-01", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社北関石田組", "2022-05-20", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("有限会社増田建材", "2022-04-26", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社河波", "2022-02-13", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("株式会社峯岸重量", "2022-01-19", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("緑化産業株式会社", "2021-09-25", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("関野建材工業株式会社", "2021-07-16", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("高宮運輸有限会社", "2021-07-09", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),
    EnfRow("有限会社ナガイ解体興業", "2021-03-30", "埼玉県", "license_revoke",
           "産業廃棄物処理業に係る行政処分", f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.saitama.lg.jp/a0506/sanpai-syobun2/syobun.html"),

    # ===== 兵庫県 (press release 2024-02-02) =====
    EnfRow("株式会社エス＆ケイ", "2024-02-02", "兵庫県", "license_revoke",
           "廃棄物処理法に係る行政処分。産業廃棄物処理業の許可取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://web.pref.hyogo.lg.jp/ehk01/202402022.html"),
    EnfRow("株式会社福谷建設", "2024-02-02", "兵庫県", "license_revoke",
           "廃棄物処理法に係る行政処分。産業廃棄物収集運搬業の許可取消し",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://web.pref.hyogo.lg.jp/ehk01/202402021.html"),

    # ===== 愛知県 (press release 2022-03-18 ka 一斉立入) =====
    EnfRow("愛知県事業停止対象事業者（2022-03-18）", "2022-03-18", "愛知県", "contract_suspend",
    ...
    EnfRow("愛知県許可取消対象事業者（2022-11-28）", "2022-11-28", "愛知県", "license_revoke",
    ...
    EnfRow("富士開発株式会社", "2024-11-17", "福岡県", "license_revoke",
    ...
    # ===== 横浜市 =====
    EnfRow("横浜市事業停止対象事業者（2023-11-21）", "2023-11-21", "横浜市", "contract_suspend",
           "産業廃棄物処理業者に対する事業停止命令",
           f"{DEFAULT_LAW} 第14条の3",
    ...
    EnfRow("大阪府許可取消対象事業者（2026-04-13公表）", "2026-04-13", "大阪府", "license_revoke",
    ...
    EnfRow("有限会社髙屋左官工芸", "2023-04-14", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第1号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第1号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r5gyouseisyobun.html"),
    EnfRow("氷上急行運輸倉庫株式会社", "2023-10-31", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第4号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第4号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r5gyouseisyobun.html"),
    EnfRow("ウィングラン株式会社", "2024-02-20", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第1号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第1号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r5gyouseisyobun.html"),
    # r6
    EnfRow("反田嘉七", "2024-10-10", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第1号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第1号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r6gyouseisyobun.html"),
    EnfRow("株式会社ヨシダ設備", "2024-11-19", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第4号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第4号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r6gyouseisyobun.html"),
    EnfRow("株式会社友工", "2024-12-13", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第4号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第4号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r6gyouseisyobun.html"),
    EnfRow("阪本勲", "2024-12-24", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第4号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第4号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r6gyouseisyobun.html"),
    EnfRow("近藤誠", "2025-02-13", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第4号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第4号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r6gyouseisyobun.html"),
    EnfRow("株式会社花山工務店", "2025-03-18", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第1号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第1号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r6gyouseisyobun.html"),
    # r7
    EnfRow("株式会社谷口建設", "2025-04-17", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第4号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第4号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r7gyouseisyobun.html"),
    EnfRow("山岡建設株式会社", "2025-04-17", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第4号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第4号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r7gyouseisyobun.html"),
    EnfRow("株式会社栄土木", "2025-10-23", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第2号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第2号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r7gyouseisyobun.html"),
    EnfRow("株式会社不川起業", "2026-02-17", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第4号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第4号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r7gyouseisyobun.html"),
    EnfRow("リンクス株式会社", "2026-03-26", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第4号）— 静岡県静岡市",
           f"{DEFAULT_LAW} 第14条の3の2第1項第4号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r7gyouseisyobun.html"),
    EnfRow("砂川順一", "2026-03-26", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第4号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第4号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r7gyouseisyobun.html"),
    EnfRow("株式会社松村", "2026-03-26", "京都府", "license_revoke",
           "産業廃棄物収集運搬業許可取消（廃棄物処理法 14条の3の2 第1項第4号）",
           f"{DEFAULT_LAW} 第14条の3の2第1項第4号",
           "https://www.pref.kyoto.jp/sanpai/syobun/r7gyouseisyobun.html"),
    ...
    EnfRow("フジ建材リース株式会社", "2021-11-09", "名古屋市", "license_revoke",
    ...
    EnfRow("フジ建材リース株式会社（処理施設）", "2021-11-09", "名古屋市", "license_revoke",
           "産業廃棄物処理施設設置許可取消し — 破産手続開始により欠格要件該当",
           f"{DEFAULT_LAW} 第15条の3第1項第1号",
           "https://www.city.nagoya.jp/_res/projects/default_project/_page_/001/026/070/r03gyouseisyobunr031201.pdf"),
    EnfRow("株式会社アイクリ", "2021-11-30", "名古屋市", "license_revoke",
           "特別管理産業廃棄物収集運搬業許可取消し — 破産手続開始により欠格要件該当",
           f"{DEFAULT_LAW} 第14条の6・第14条の3の2第1項第4号",
           "https://www.city.nagoya.jp/_res/projects/default_project/_page_/001/026/070/r03gyouseisyobunr031201.pdf"),
    EnfRow("有限会社山田商店", "2024-02-27", "名古屋市", "license_revoke",
    ...
    EnfRow("株式会社河波", "2021-06-11", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("有限会社太陽建設", "2021-12-07", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社和泉造園", "2021-12-21", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社峯岸重量", "2022-01-19", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社リバイブマツヤマ", "2022-01-19", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業/処分業 許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("子安忍", "2022-01-28", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("有限会社金田又介商店", "2022-07-26", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社ゼットライン", "2023-01-27", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("有限会社ケイハツ", "2023-05-16", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("有限会社横関運輸", "2023-08-31", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社日彩", "2023-11-10", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社東京高英", "2023-11-10", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("有限会社篠原造園土木", "2024-02-09", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("有限会社沖杉興業", "2024-02-22", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社吉岡開発", "2024-09-13", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社ユウキ", "2025-06-03", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("有限会社松島組", "2025-07-09", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社リブ・ウイズ（栃木県）", "2025-07-09", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社東邦運輸（栃木県）", "2025-09-09", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社サングリーン（栃木県）", "2025-09-26", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("dbクリーン株式会社（栃木県）", "2025-11-11", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社ASUKA", "2025-12-05", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社ジャパンクリーン", "2025-12-17", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    EnfRow("株式会社エコ・ディスタンス", "2025-12-17", "栃木県", "license_revoke",
           "産業廃棄物収集運搬業許可取消 — 法第14条第5項該当（欠格要件該当）",
           f"{DEFAULT_LAW} 第14条第5項",
           "https://www.pref.tochigi.lg.jp/d05/eco/haikibutsu/haikibutsu/documents/0209syobun_list.pdf"),
    ...
    EnfRow("羽黒・稲田石材スラッジ処理協同組合", "2021-07-06", "茨城県", "license_revoke",
           "産業廃棄物処分業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("羽黒・稲田石材スラッジ処理協同組合（施設）", "2021-07-06", "茨城県", "license_revoke",
           "産業廃棄物処理施設(汚泥脱水/管理型最終処分場)設置許可取消",
           f"{DEFAULT_LAW} 第15条の3",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("関野建材工業株式会社", "2021-07-15", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社アイテック", "2021-08-12", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("有限会社増田建材", "2021-08-17", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("友常石材株式会社", "2021-09-27", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社グローバルクリエイション", "2021-10-22", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("中国通商株式会社", "2022-02-25", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社磯前商店（収集運搬）", "2022-03-29", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社磯前商店（処分業）", "2022-03-29", "茨城県", "license_revoke",
           "産業廃棄物処分業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社磯前商店（特管収運）", "2022-03-29", "茨城県", "license_revoke",
           "特別管理産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の6",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社磯前商店（処理施設）", "2022-03-29", "茨城県", "license_revoke",
           "産業廃棄物処理施設(圧縮・切断施設)設置許可取消",
           f"{DEFAULT_LAW} 第15条の3",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("田城芳一", "2022-05-25", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("有限会社塚本興商", "2023-03-16", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社ゼットライン（茨城県）", "2023-03-28", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("有限会社ケイハツ（茨城県）", "2023-03-30", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社清丸", "2023-07-14", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社蔵創", "2023-12-11", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社東京高英（茨城県）", "2024-04-08", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社長岡商会", "2024-04-08", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社日彩（茨城県）", "2024-06-05", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("有限会社日栄商事", "2024-06-05", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("有限会社塚田埋設工事", "2024-08-27", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("砂押プラリ株式会社", "2024-08-27", "茨城県", "license_revoke",
           "特別管理産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の6",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社内田工業", "2024-09-27", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("有限会社松島組（茨城県）", "2025-03-21", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社大翔", "2025-05-15", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社山友興業", "2025-06-13", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社東邦運輸（茨城県）", "2025-07-04", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社リブ・ウイズ（茨城県）", "2025-07-18", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社常磐", "2025-07-18", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社ユウキ（茨城県）", "2025-07-18", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("有限会社西満商事", "2025-08-07", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社サングリーン（茨城県）", "2025-08-07", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社武子工業", "2025-08-20", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社ナカヤ商事", "2025-08-20", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("dbクリーン株式会社（茨城県）", "2025-09-11", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社大平工務店", "2025-11-07", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社トーシン（茨城県・収運）", "2025-11-07", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社トーシン（茨城県・特管）", "2025-11-07", "茨城県", "license_revoke",
           "特別管理産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の6",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社レイコーポレーション", "2025-11-07", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社MKシステム", "2025-11-07", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社鹿嶋エコプラント（処分業）", "2025-11-07", "茨城県", "license_revoke",
           "産業廃棄物処分業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社鹿嶋エコプラント（処理施設）", "2025-11-07", "茨城県", "license_revoke",
           "産業廃棄物処理施設(脱水/中和)設置許可取消",
           f"{DEFAULT_LAW} 第15条の3",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("有限会社林材木店", "2025-11-25", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社永利建設工業（茨城県）", "2025-12-16", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("有限会社海老澤産業", "2025-12-16", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("三の丸興産株式会社（処分業）", "2026-02-13", "茨城県", "license_revoke",
           "産業廃棄物処分業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("三の丸興産株式会社（処理施設）", "2026-02-13", "茨城県", "license_revoke",
           "産業廃棄物処理施設(がれき類破砕施設)設置許可取消",
           f"{DEFAULT_LAW} 第15条の3",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
    EnfRow("株式会社天馬", "2026-02-13", "茨城県", "license_revoke",
           "産業廃棄物収集運搬業許可取消",
           f"{DEFAULT_LAW} 第14条の3の2",
           "https://www.pref.ibaraki.jp/seikatsukankyo/haitai/fuho/fuho-toki/documents/gyouseisyobunlist20260421.pdf"),
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    ap.add_argument("--seed-only", action="store_true",
                    help="skip live HTTP fetches, use SEED_ROWS only")
    ap.add_argument("--target", type=int, default=250,
                    help="target number of new rows to insert (default 250)")
