...
| Field | Value |
|---|---|
| display_name | jpcite — 日本の制度 MCP (96 tools) |
...
```
AutonoMath: 96-tool MCP (39 core + 50 autonomath entity-fact DB) over Japanese primary-gov data — 11,684 programs + 503,930 entities + 6.12M facts + 378,342 relations, 181 exclusion rules, 3-axis loan risk. ¥3/req; 3/日 free.
```

### Long description (≤500 chars)

```
AutonoMath provides structured access to Japanese public-program data via 96 MCP tools (protocol
...
#   AutonoMath: 96-tool MCP over 11,684 searchable Japanese public programs (out of 14,472 total), 181 exclusion rules,
