...
CREATE VIEW IF NOT EXISTS jc_a2a_handshake_log AS SELECT * FROM am_a2a_handshake_log;
CREATE VIEW IF NOT EXISTS jc_aggregated_outcome_view AS SELECT * FROM am_aggregated_outcome_view;
CREATE VIEW IF NOT EXISTS jc_anonymized_query_log AS SELECT * FROM am_anonymized_query_log;
CREATE VIEW IF NOT EXISTS jc_audit_workpaper AS SELECT * FROM am_audit_workpaper;
CREATE VIEW IF NOT EXISTS jc_audit_workpaper_run_log AS SELECT * FROM am_audit_workpaper_run_log;
CREATE VIEW IF NOT EXISTS jc_composed_tool_catalog AS SELECT * FROM am_composed_tool_catalog;
CREATE VIEW IF NOT EXISTS jc_composed_tool_invocation_log AS SELECT * FROM am_composed_tool_invocation_log;
CREATE VIEW IF NOT EXISTS jc_copilot_session_log AS SELECT * FROM am_copilot_session_log;
CREATE VIEW IF NOT EXISTS jc_copilot_widget_config AS SELECT * FROM am_copilot_widget_config;
CREATE VIEW IF NOT EXISTS jc_counterfactual_eval_log AS SELECT * FROM am_counterfactual_eval_log;
CREATE VIEW IF NOT EXISTS jc_credit_spending_alert AS SELECT * FROM am_credit_spending_alert;
CREATE VIEW IF NOT EXISTS jc_credit_transaction_log AS SELECT * FROM am_credit_transaction_log;
CREATE VIEW IF NOT EXISTS jc_credit_wallet AS SELECT * FROM am_credit_wallet;
CREATE VIEW IF NOT EXISTS jc_fact_attestation_log AS SELECT * FROM am_fact_attestation_log;
CREATE VIEW IF NOT EXISTS jc_fact_metadata AS SELECT * FROM am_fact_metadata;
CREATE VIEW IF NOT EXISTS jc_fact_signature_v2_attestation AS SELECT * FROM am_fact_signature_v2_attestation;
CREATE VIEW IF NOT EXISTS jc_fact_signature_v2_revocation_log AS SELECT * FROM am_fact_signature_v2_revocation_log;
CREATE VIEW IF NOT EXISTS jc_federated_mcp_partner AS SELECT * FROM am_federated_mcp_partner;
CREATE VIEW IF NOT EXISTS jc_handoff_log AS SELECT * FROM am_handoff_log;
CREATE VIEW IF NOT EXISTS jc_monthly_snapshot_log AS SELECT * FROM am_monthly_snapshot_log;
CREATE VIEW IF NOT EXISTS jc_observability_metric AS SELECT * FROM am_observability_metric;
CREATE VIEW IF NOT EXISTS jc_personalization_profile AS SELECT * FROM am_personalization_profile;
CREATE VIEW IF NOT EXISTS jc_personalization_recommendation_log AS SELECT * FROM am_personalization_recommendation_log;
CREATE VIEW IF NOT EXISTS jc_predictive_alert_log AS SELECT * FROM am_predictive_alert_log;
CREATE VIEW IF NOT EXISTS jc_predictive_watch_subscription AS SELECT * FROM am_predictive_watch_subscription;
CREATE VIEW IF NOT EXISTS jc_realtime_signal_event_log AS SELECT * FROM am_realtime_signal_event_log;
CREATE VIEW IF NOT EXISTS jc_realtime_signal_subscriber AS SELECT * FROM am_realtime_signal_subscriber;
CREATE VIEW IF NOT EXISTS jc_rule_tree_chain AS SELECT * FROM am_rule_tree_chain;
CREATE VIEW IF NOT EXISTS jc_rule_tree_eval_log AS SELECT * FROM am_rule_tree_eval_log;
CREATE VIEW IF NOT EXISTS jc_rule_tree_version_history AS SELECT * FROM am_rule_tree_version_history;
CREATE VIEW IF NOT EXISTS jc_rule_trees AS SELECT * FROM am_rule_trees;
CREATE VIEW IF NOT EXISTS jc_semantic_search_v1_cache AS SELECT * FROM am_semantic_search_v1_cache;
CREATE VIEW IF NOT EXISTS jc_semantic_search_v1_log AS SELECT * FROM am_semantic_search_v1_log;
CREATE VIEW IF NOT EXISTS jc_session_context AS SELECT * FROM am_session_context;
CREATE VIEW IF NOT EXISTS jc_session_step_log AS SELECT * FROM am_session_step_log;
CREATE VIEW IF NOT EXISTS jc_webmcp_endpoint AS SELECT * FROM am_webmcp_endpoint;
CREATE VIEW IF NOT EXISTS jc_x402_endpoint_config AS SELECT * FROM am_x402_endpoint_config;
CREATE VIEW IF NOT EXISTS jc_x402_payment_log AS SELECT * FROM am_x402_payment_log;
