...
def _sanitize_preserved_prefix(prefix: str) -> str:
    replacements = {
        ...
        ): "jpcite は MCP (Model Context Protocol) サーバーとして 151 ツールを公開します。Claude Desktop / Cursor / Cline などの stdio MCP クライアントで使えます。ChatGPT Custom GPT は OpenAPI Actions を使います。",
