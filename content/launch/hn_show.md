# Show HN: AutonoMath – one API for Japanese subsidy, loan, tax, certification data
...
https://autonomath.ai | Docs: https://autonomath.ai/docs | `pip install autonomath-mcp`
