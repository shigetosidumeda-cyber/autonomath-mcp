---
title: "日本の補助金・融資データ 9,998 件を 1 本の REST API にまとめた話"
emoji: "🗂️"
type: "tech"
topics: ["api", "python", "fastapi", "llm", "japan"]
published: false
---
...
全 9,998 件に `source_url` と `fetched_at` が付いています。
...
- 9,998 件の一次資料補助金データが `curl` 1 本で取れる
