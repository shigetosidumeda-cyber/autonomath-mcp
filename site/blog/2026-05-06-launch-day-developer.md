...
description: "AutonoMath ローンチ記事 (Article 1 of 2) — 補助金・融資・税制・認定制度 14,472 件、採択事例 2,286 件、融資 108 件、排他ルール 181 本を 1 本の REST API で提供する設計背景。"
tags:
  - api
  - python
  - fastapi
...
匿名では 3 req/日（JST 月初 00:00 リセット）まで無料です。
...
全 14,472 件に `source_url` と `fetched_at` が付いています。
...
| | 上限 | リセット |
|---|---|---|
| 匿名（API キーなし） | 3 req/日 per IP | JST 月初 00:00 |
