...
| MCP ツール総数 | 66 (38 jpintel + 28 autonomath, `list_tax_sunset_alerts` 含む) |
...
| 法令 | 9,484 | e-Gov 法令データ提供システム (CC-BY) |
...
| entity-fact aliases | 335,605 | am_alias |
| am_law_article | 28,048 | autonomath.db |
| am_enforcement_detail | 22,258 | autonomath.db |
...
| データベース | SQLite FTS5 trigram (jpintel.db 188 MB + autonomath.db 7.36 GB) |
| OpenAPI | https://api.autonomath.ai/v1/openapi.json |
