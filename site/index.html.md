...
税理士・会計士・行政書士・M&A・信金。AI agent 経由で月 ¥270〜¥1,125、ROI 37〜2,688 倍。 
...
士業本人がブラウズする想定ではなく、Claude / GPT / Cursor 側に jpcite を bundle した AI agent を業務に組み込む 6 業種シナリオ。ROI は [業種別 use case ](/docs/use_cases/by_industry_2026_05_11.md)に詳細。 
...
回避コスト・sequence・envelope 仕様は [業種別 use case 詳細 ](/docs/use_cases/by_industry_2026_05_11.md)・ [課金根拠 ](/docs/pricing/justification_2026_05_11.md)を参照。最終判断は 8 業法の有資格者 (税理士法§52 / 弁護士法§72 / 行政書士法§1 / 司法書士法§3 / 公認会計士法§47条の2 / 社労士法§27 / 中小企業診断士登録規則 / 弁理士法§75)。 

- [会社フォルダ作成パック ](/products/company-folder): 1 社 ¥59.40 (18 req) 
- [顧問先月次レビュー ](/products/monthly-review): 100 社月 ¥5,940 (25x ROI) 
...
利用者層 別の専用ページに、 ROI 試算 + サンプル API + 既知の制約を載せています。 
