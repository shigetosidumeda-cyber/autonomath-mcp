-- q32_allwave_53_85_grand_aggregate.sql (Wave 83-85)
--
-- Grand aggregate row-count per wave_family across the full Wave 53
-- → 85 corpus. Successor to wave67/q11 (Wave 53-67), wave70/q21
-- (Wave 53-76 fy × jsic), wave82/q27 (Wave 53-82), and the Q28-Q31
-- family-shaped queries above. This is the canonical "show me the
-- footprint of everything" surface — one row per (wave_family,
...
--   wave81     esg            carbon / climate alignment / transition
--   wave82     ip             patent / trademark
--   wave83     climate phys   physical_climate / scope1_2 / scope3
--   wave84     demographic    city / prefecture / rural (Wave 84
--                              FULL-SCALE 30 generators task #230 pending)
...
WITH grand AS (
  ...
  -- Wave 84 demographics (proxies pending FULL-SCALE task #230)
  UNION ALL
