...
- `src/jpintel_mcp/mcp/server.py` — FastMCP entry point, 96 tools total at default gates (3 broken tools gated off pending fix — see Architecture above):
