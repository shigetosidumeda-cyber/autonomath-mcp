...
DEFAULT_ZEIMU_KAIKEI_BASE_URL: Final = "https://api.zeimu-kaikei.ai"
...
class Settings:
    ...
    mf_revoke_url: str
    mf_scope: str
    zeimu_kaikei_base_url: str
    zeimu_kaikei_api_key: str
    plugin_base_url: str
    session_secret: str
    node_env: str
    port: int
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        zeimu_kaikei_base_url=os.environ.get(
            "ZEIMU_KAIKEI_BASE_URL", DEFAULT_ZEIMU_KAIKEI_BASE_URL
        ),
        zeimu_kaikei_api_key=os.environ["ZEIMU_KAIKEI_API_KEY"],
