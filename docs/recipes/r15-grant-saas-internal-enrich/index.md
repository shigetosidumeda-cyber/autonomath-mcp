...
- API fee delta: SaaS 顧客 50,000 社 月次 enrich で、外部 model/search API fee は約 ¥500,000/月 (1 社 cycle ¥10 = 法人 6 source + 適格事業者 + 採択履歴) に対し jpcite は ¥150,000/月 (50,000 req × ¥3) → API fee delta 約 ¥350,000/月 / 顧客あたり ¥7 (cf. `docs/canonical/cost_saving_examples.md` case 3 / case 5 同系)
