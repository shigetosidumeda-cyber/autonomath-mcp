---
title: "日本の補助金・融資データ 13,578 件を 1 本の REST API にまとめた話"
description: "AutonoMath ローンチ記事 (Article 1 of 2) — 補助金・融資・税制・認定制度 13,578 件、採択事例 2,286 件、融資 108 件、排他ルール 181 本を 1 本の REST API で提供する設計背景。"
tags:
  - api
  - python
  - fastapi
...
匿名では 50 req/月（JST 月初 00:00 リセット）まで無料です。
...
全 13,578 件に `source_url` と `fetched_at` が付いています。
...
2026-04-24 拡張では法令 (e-Gov CC-BY, 6,850+ 件・継続ロード中) と税務ルールセット (インボイス+電帳法, 35 件)
