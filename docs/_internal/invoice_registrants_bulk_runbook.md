...
4. Privacy guardrail. Sole-proprietor rows are personal data under
   ...
   path on `autonomath.ai` **before** the full mirror lands; that work
...
curl -sS https://api.autonomath.ai/v1/invoice_registrants/T8010001213708 | jq .
```
...
- [ ] Privacy / takedown landing page on autonomath.ai for
