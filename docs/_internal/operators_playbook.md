...
- `curl -sS -o /dev/null -w '%{http_code}\n' https://autonomath.ai/healthz` が 5xx or timeout
...
1. Cloudflare Dashboard → `autonomath.ai` → DNS → Records
...
4. smoke: `BASE_URL=https://autonomath.ai ./scripts/smoke_test.sh`
