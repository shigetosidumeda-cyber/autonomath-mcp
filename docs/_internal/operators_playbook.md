...
- `curl -sS -o /dev/null -w '%{http_code}\n' https://zeimu-kaikei.ai/healthz` が 5xx or timeout
...
1. Cloudflare Dashboard → `zeimu-kaikei.ai` → DNS → Records
...
4. smoke: `BASE_URL=https://zeimu-kaikei.ai ./scripts/smoke_test.sh`
