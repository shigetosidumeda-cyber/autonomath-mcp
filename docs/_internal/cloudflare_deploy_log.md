...
- `autonomath.ai` is **already live** on Cloudflare (apex + Pages).
...
- `api.autonomath.ai` returns HTTP 503 from Fly (separate Fly app, not in
...
```
$ dig +short autonomath.ai A
172.67.210.190
104.21.45.66

$ dig +short autonomath.ai AAAA
2606:4700:3037::ac43:d2be
2606:4700:3036::6815:2d42

$ dig +short autonomath.ai NS
...
```
Cloudflare dashboard → autonomath.ai zone
...
export CF_ZONE_ID=<autonomath.ai zone id>
...
- `project_autonomath_prod_drift_2026_04_24` — api.autonomath.ai
