...
|---|-----------|------|-----------------|-----------|
| A | Indie AI 開発者 (日本 SMB 向けツール製作) | 10 | Zenn / Qiita の MCP/LLM 記事コメント、X #AI #MCP #Claude hashtag、Smithery/MCP registry 掲載者の DM | Paid ¥3/billable unit の主購買層 (月 1K-10K req 帯)。払う動機と抵抗を最優先で取る |
| B | Mid-sized SaaS engineer (日本 SaaS で社内 AI 機能を作る側) | 10 | Smart HR / freee / SmartRound の X mutual follow、Japan SaaS Slack、勉強会 LT 登壇者 | Paid ¥3/billable unit のヘビー帯 (月 10K-100K req)。稟議プロセスと internal buy-in の阻害要因を取る |
...
- 「従量 ¥3/billable unit、月 1 万 req で ¥30,000、10 万 req で ¥30 万。自分のカードで払いますか、会社の経費ですか」(払う主体を特定)
