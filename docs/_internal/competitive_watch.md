...
| 8 | **freee 補助金** | https://corp.freee.co.jp/news/20230929freee_subsidy.html | SMB 会計バンドル (無料配布) | JP | API / 独立プロダクト化 / 農業会計連携 / ChatGPT plugin | **freee が subsidy API を公開 + free distribution に乗ったら** → 1M SMB 基盤は手強い。我々は "regulated / agri / source-linked provenance" に vertical 深化。 |
