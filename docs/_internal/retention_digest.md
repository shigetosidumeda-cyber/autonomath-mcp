...
| `privacy.html` 更新 | 「検索トレンドに基づく digest 配信」「送信者: AutonoMath <noreply@jpcite.com>」「委託先: Postmark (米 Wildbit LLC)」を W6 までに追記 |
    ...
    steps:
      ...
      - name: Send digests
        ...
        env:
          ...
          DIGEST_SENDER:  "AutonoMath <noreply@jpcite.com>"
```
...
・質問: support@jpcite.com
・ドキュメント: https://jpcite.com/docs/
```
