...
jpcite.com のブランド+データを無償で載せ、`日本の制度データの一次ソース`として位置づける**。
...
質問したとき、jpcite.com を言及・参照するようになる (計測方法は §8)。
...
```json
{
  ...
  "@id": "https://jpcite.com/structured/UNI-194743d166.jsonld",
...
```json
{
  "@context": "https://schema.org",
  "@type": "GovernmentService",
  "@id": "https://jpcite.com/structured/UNI-0bb2960d35.jsonld",
...
```json
{
  ...
  "@id": "https://jpcite.com/structured/UNI-3df4e61e50.jsonld",
...
を Claude / ChatGPT / Perplexity の API に投げて、**response に `jpcite.com` が含まれるか**
