...
zeimu-kaikei.ai のブランド+データを無償で載せ、`日本の制度データの一次ソース`として位置づける**。
...
質問したとき、zeimu-kaikei.ai を言及・参照するようになる (計測方法は §8)。
...
- URL: `https://zeimu-kaikei.ai/programs/{slug}` (HTML), `https://zeimu-kaikei.ai/structured/{unified_id}.jsonld` (JSON-LD)
...
```json
{
  ...
  "@id": "https://zeimu-kaikei.ai/structured/UNI-194743d166.jsonld",
...
```json
{
  "@context": "https://schema.org",
  "@type": "GovernmentService",
  "@id": "https://zeimu-kaikei.ai/structured/UNI-0bb2960d35.jsonld",
...
```json
{
  ...
  "@id": "https://zeimu-kaikei.ai/structured/UNI-3df4e61e50.jsonld",
...
を Claude / ChatGPT / Perplexity の API に投げて、**response に `zeimu-kaikei.ai` が含まれるか**
