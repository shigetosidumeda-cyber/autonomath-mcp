...
306 REST/OpenAPI paths + 184 MCP tools. ¥3/req metered. Built for AI
...
fetched_at + content_hash. 306 REST/OpenAPI paths and 184 MCP tools so
...
- [ ] **Gallery images** (1270×760 PNG, up to 6):
  ...
  - [ ] 4: REST/OpenAPI 302-path explorer.
