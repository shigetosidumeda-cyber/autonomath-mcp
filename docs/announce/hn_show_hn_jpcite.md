...
a 182-path OpenAPI + a 151-tool MCP server + a GraphQL endpoint.
...
and 8 業法 fences (税理士法 §52 / 弁護士法 §72 / 金商法 §29 / 行政書士法 §1
...
- 182 OpenAPI paths + 151 MCP tools + 5 GraphQL types under one
