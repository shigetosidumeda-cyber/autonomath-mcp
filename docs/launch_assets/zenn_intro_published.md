...
**139 ツール**  + 30 autonomath = 17 V1 + 4 メタデータ tools + 7 静的データセット tools、protocol 2025-06-18) が即座に Claude Desktop / Cursor / ChatGPT から呼べます。
...
1. **AI agent 開発者** — Claude / Cursor / ChatGPT の Manifest 1 行で 139 ツール、SDK 不要
...
2. **MCP プロトコル 2025-06-18 の 139 ツール schema validation**
