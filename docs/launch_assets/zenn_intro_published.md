...
description: "AutonoMath ローンチ — 13,578 件の補助金・融資・税制・認定を REST + MCP 69 ツールで横断検索。¥3/req 完全従量、50 req/月 per IP 無料。"
tags:
  - api
  - mcp
  - llm
...
> 公開日: 2026-05-06 / 運営: Bookyou株式会社 (T8010001213708) / Canonical: <https://zeimu-kaikei.ai>
...
| autonomath エンティティ | **503,930** + 6.12M facts + 23,805 relations | EAV エンティティ事実 DB (拡張データセット + 静的データセット tools 統合済み) |
...
```bash
curl -sS https://api.zeimu-kaikei.ai/v1/programs/search \
...
**69 ツール** (39 jpintel + 30 autonomath = 17 V1 + 4 メタデータ tools + 7 静的データセット tools、protocol 2025-06-18) が即座に Claude Desktop / Cursor / ChatGPT から呼べます。
...
1. **AI agent 開発者** — Claude / Cursor / ChatGPT の Manifest 1 行で 69 ツール、SDK 不要
...
2. **MCP プロトコル 2025-06-18 の 69 ツール schema validation**
...
- [Getting Started (5 分)](https://zeimu-kaikei.ai/docs/getting-started/)
- [API リファレンス](https://zeimu-kaikei.ai/docs/api-reference/)
- [MCP ツール一覧](https://zeimu-kaikei.ai/docs/mcp-tools/)
- [pricing.md](https://zeimu-kaikei.ai/docs/pricing/)
