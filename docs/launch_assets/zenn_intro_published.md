...
description: "jpcite ローンチ — 14,472 件の補助金・融資・税制・認定を REST + MCP 151 ツールで横断検索。¥3/billable unit 完全従量、3 req/日 per IP 無料。"
tags:
  - api
  - mcp
  - llm
...
**151 ツール**  + 30 autonomath = 17 V1 + 4 メタデータ tools + 7 静的データセット tools、protocol 2025-06-18) が即座に Claude Desktop / Cursor / ChatGPT から呼べます。
...
1. **AI agent 開発者** — Claude / Cursor / ChatGPT の Manifest 1 行で 151 ツール、SDK 不要
...
2. **MCP プロトコル 2025-06-18 の 151 ツール schema validation**
