...
- 30 min 以内応答できないと判明した場合のみ:
  1. status page (`jpcite.com/status`) に手動で incident 起票
  2. `service@jpcite.com` 自動応答に "investigating" を一時掲示
