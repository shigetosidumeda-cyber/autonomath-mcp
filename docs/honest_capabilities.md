...
| データ種別 | 検索対象 件数 |
|---|---|
| 補助金 / 助成金 / 認定 | 11,601 (tier S/A/B/C) |
| 採択事例 | 2,286 |
...
- **法令条文** — e-Gov 全文ロード継続中 (本文索引 6,493 件 + メタデータ 9,484 件、resolver で全件にリーチ可能)
- **トークン / LLM 文脈量** — context 比較は caller supplied baseline がある場合だけ入力文脈量の参考値として返します。
