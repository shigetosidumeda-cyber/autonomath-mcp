...
- [ ] Cloudflare Pages production deploy 確認 (jpcite.com)
- [ ] Fly.io production deploy 確認 (api.jpcite.com)
...
- [ ] 件名: `[jpcite] 本日 launch — 日本の公的制度を AI agent から 1 query で`
...
- [ ] `docs/blog/` に「jpcite launch 後 7 日のメトリクス」blog 記事を新規作成
