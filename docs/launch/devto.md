...
src/jpintel_mcp/
  ...
  mcp/      FastMCP stdio server (155 tools, protocol 2025-06-18)
...
155 tools at default gates, protocol `2025-06-18`, FastMCP over stdio. The tool inventory mirrors the REST surface: search, get-by-ID, lifecycle, prerequisite chain, rule-engine check, snapshot-time queries, provenance lookup. Drop into Claude Desktop config:
