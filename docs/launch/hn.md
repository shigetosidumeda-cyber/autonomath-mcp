...
- **MCP**: 93 tools at default gates, protocol 2025-06-18. Drop into Claude Desktop config and ask in Japanese — it routes through search → primary-URL records.
- **Pricing**: ¥3/req metered (≈ $0.02), 税込 ¥3.30. 3 req/day free anonymously, no signup. No tiers, no seat fees, no annual minimums. Solo founder + zero-touch ops, so it has to be self-service.
