...
- [OK] scoped_api_token: 36 file(s) reference X-API-Key/jc_ prefix
...
- [OK] streamable_http: mcp-server.json _meta.transports=3 values, a2a agent_card advertises stdio+streamable_http, src/doc markers=1/7
...
- [OK] 1_idempotency: src/scripts hits=24
- [OK] 2_retry_policy: retry/backoff anchors=10
- [OK] 3_circuit_breaker: circuit_breaker anchors=45
- [OK] 4_dlq: DLQ anchors=1
- [OK] 5_canary: canary/rolling anchors=9
- [OK] 6_degradation: degradation anchors=19
- [OK] 7_failover: failover/DR anchors=37
- [OK] 8_chaos: chaos anchors=5
- [OK] 9_postmortem_v2_base: docs/postmortem entries=2
