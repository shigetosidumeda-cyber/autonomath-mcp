...
- [OK] streamable_http: mcp-server.json _meta.transports=3 values, a2a agent_card advertises stdio+streamable_http, src/doc markers=1/13
...
- [OK] 7_failover: failover/DR anchors=43
