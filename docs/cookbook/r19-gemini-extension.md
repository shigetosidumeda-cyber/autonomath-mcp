...
JPCITE = "https://api.jpcite.com"  # add ?src=cookbook_r19-gemini-extension on first call from this recipe to attribute downstream conversion
...
- `tools` declaration が長くなる場合は openapi-to-fc 変換を介して `https://api.jpcite.com/v1/openapi.agent.json?src=cookbook_r19-gemini-extension` から自動生成するのが楽。
