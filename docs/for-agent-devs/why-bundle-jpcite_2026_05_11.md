...
- **業法 fence**: 8 canonical (税理士法§52 / 弁護士法§72 / 公認会計士法§47条の2 / 行政書士法§1の2・§19 / 司法書士法§3 / 社会保険労務士法§27 / 弁理士法§75 / 労働基準法§36)。agent 側に `_disclaimer` 付き envelope が自動で乗る → agent dev は独占業務踏み込みを設計時に意識する手間が無くなる。
